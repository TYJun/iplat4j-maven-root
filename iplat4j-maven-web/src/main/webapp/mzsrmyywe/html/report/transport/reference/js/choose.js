    ...
    $.fn.fSelect = function(options) {
        ...
        fSelect.prototype = {
            create: function() {
                ...
                //添加全选和清空按钮
                // var BtnFixed =
                //     '<div class="btnFixed"><button class="buttonDefault" id="selectAllBtn" type="button">全选</button><button class="buttonDefault" id="clearAllBtn" type="button">清空</button></div>';
            ...
            buildOptions: function($element) {
                ...
                $element.children().each(function(i, el) {
                    ...
                    if ("optgroup" == $el.prop("nodeName").toLowerCase()) {
                        ...
                        choices +=
                            '<div class="fs-optgroup-label">' + $el.prop("label") + "</div>";
            ...
            reloadDropdownLabel: function() {
                ...
                this.$wrap.find(".fs-option.selected").each(function(i, el) {
                    ...
                    console.log($(el))
                    labelVal.push($(el).attr('data-value'))
                });
