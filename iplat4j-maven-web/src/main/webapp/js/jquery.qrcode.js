(function (qrcode) {
    ...
    function drawOnCanvas(canvas, settings) {
        ...
        {
        	 var iHeight=$canvas[0].height;
             var iWidth=$canvas[0].width;
             var iImageHeight=parseInt(iHeight/5.0);
             var iImageWidth=parseInt(iHeight/5.0);
             var iImageTop=parseInt((iHeight-iImageHeight)/2.0);
             var iImageLeft=parseInt((iWidth-iImageWidth)/2.0);
             var pImage=new Image();
             pImage.src=settings.logo;
             context.drawImage(pImage,iImageLeft,iImageTop,iImageWidth,iImageHeight);
        }
        return $canvas;
    }
