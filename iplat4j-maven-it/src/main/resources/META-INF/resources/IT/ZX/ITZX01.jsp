    ...
    <div class="row">
        <EF:EFRegion id="inqu" title="查询条件">
            <div class="row">
                ...
                <EF:EFInput ename="inqu_status-0-serveDeptName" cname="服务科室" type="hidden"/>
        ...
        <EF:EFWindow id="popData" url="" lazyload="true" width="80%" height="80%" title="独立任务执行" modal="true" />
    </div>
</EF:EFPage>
