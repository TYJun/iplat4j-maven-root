...
<EF:EFPage>
    <EF:EFRegion>
        ...
        <div class="row">
            <EF:EFInput ename="evalPoint" cname="服务评价" colWidth="4" ratio="4:6" readonly="true"/>
            <EF:EFInput ename="evalAdvice" cname="评价意见" type="textarea" colWidth="4" ratio="4:6" readonly="true"/>
        </div>
        <div id="invalid">
            <div class="row">
                <EF:EFInput ename="invalidReason" cname="作废原因" type="textarea" colWidth="4" ratio="4:6" readonly="true"/>
                <EF:EFInput ename="invalidManName" cname="作废人" colWidth="4" ratio="4:6" readonly="true"/>
                <EF:EFInput ename="invalidTime" cname="作废时间" colWidth="4" ratio="4:6" readonly="true"/>
            </div>
        </div>
