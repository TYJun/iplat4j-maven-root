    ...
    <div class="row">
        <EF:EFRegion id="inqu" title="查询条件">
            <div class="row">
                ...
                <EF:EFSelect ename="inqu_status-0-status" cname="状态">
                    <EF:EFOption label="请选择" value=""/>
                    <EF:EFOption label="待提交" value="00"/>
                    <EF:EFOption label="待完工" value="01"/>
                    <EF:EFOption label="待评价" value="02"/>
                    <EF:EFOption label="已结束" value="03"/>
                    <EF:EFOption label="已作废" value="10"/>
                </EF:EFSelect>
            </div>
        ...
        <EF:EFRegion id="result" title="任务列表">
            <EF:EFGrid blockId="result" autoDraw="no" readonly="true" checkMode="single,row" rowNo="true">
                ...
                <EF:EFColumn ename="taskNo" cname="任务单号" width="200" enable="false" align="center" displayType="url"/>
                <EF:EFColumn ename="statusMean" cname="状态" width="100" enable="false" align="center"/>
                ...
                <EF:EFColumn ename="classifyName" cname="服务分类" width="100" enable="false" align="center"/>
                ...
                <EF:EFColumn ename="finishManName" cname="完工人" width="100" enable="false" align="center"/>
                <EF:EFColumn ename="recCreateTime" cname="创建时间" width="100" enable="false" align="center"/>
                <EF:EFColumn ename="finishTime" cname="完工时间" width="100" enable="false" align="center"/>
                <EF:EFColumn ename="remark" cname="备注" width="100" enable="false" align="center"/>
            </EF:EFGrid>
        </EF:EFRegion>
        <EF:EFWindow id="popData" url="" lazyload="true" width="80%" height="80%" title="独立任务综合查询" modal="true" />
    </div>
</EF:EFPage>
