...
<EF:EFPage>
    <EF:EFRegion id="info" head="hidden">
        ...
        <div class="row">
            <EF:EFInput ename="serveContent" cname="服务内容" colWidth="5" rows="3" type="textarea" placeholder="不能超过200字" required="true"/>
            <EF:EFInput ename="remark" cname="备注" colWidth="5" rows="3" type="textarea" placeholder="不能超过200字"/>
        </div>

        <div id="invalid">
            <div class="row">
                <EF:EFInput ename="invalidReason" cname="作废原因" colWidth="5" rows="3" type="textarea" placeholder="不能超过200字" required="true"/>
            </div>
        </div>
