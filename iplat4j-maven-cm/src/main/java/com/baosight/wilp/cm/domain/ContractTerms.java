/**
* Generate time : 2021-03-04 17:30:20
 ...
 * 合同类型表实体类
 * 
 * @Title: ContractTerms.java
 * @ClassName: ContractTerms
 * @Package：com.baosight.wilp.cm.domain
 * @author: zhaow
 * @date: 2021年8月30日 下午2:43:05
 * @version: V1.0
 ...
 * <desc>    // 描述修改内容
 */
public class ContractTerms extends DaoEPBase {
    ...
    private String contTermContent = " ";		/* 合同条款内容*/
    ...
    public void initMetaData() {
        ...
        eiColumn = new EiColumn("contTermContent");
        eiColumn.setDescName("合同条款内容");
        eiMetadata.addMeta(eiColumn);
    ...
    /**
     * get the contTermContent - 合同条款内容
     * @return the contTermContent
     */
    public String getContTermContent() {
        return this.contTermContent;
    }

    /**
     * set the contTermContent - 合同条款内容
     */
    public void setContTermContent(String contTermContent) {
        this.contTermContent = contTermContent;
    }
    ...
    public void fromMap(Map map) {
        ...
        setContTermContent(StringUtils.defaultIfEmpty(StringUtils.toString(map.get("contTermContent")), contTermContent));
    ...
    public Map toMap() {
        ...
        map.put("contTermContent",StringUtils.toString(contTermContent, eiMetadata.getMeta("contTermContent")));
