...
<EF:EFPage>
	...
	<EF:EFTab id="tab_tab_grid" >
		<div title="付款协议明细">
			<EF:EFGrid blockId="resultA" needAuth="false" autoDraw="no" readonly="true" queryMethod="queryPay"
			isFloat="true" copyToAdd="false" checkMode="single,row" checkNewLine="false" rowNo="true" >
				...
				<EF:EFColumn ename="payRate" cname="付款比例(%)" width="100" data-regex="/^(?:0|[1-9][0-9]?|100)$/" data-errorprompt="请输入0-100 之间的数字" align="center"/>
