...
<EF:EFPage>
	<EF:EFRegion id="inqu" title="查询条件" showClear="true">
		...
		<div class="row">
			<EF:EFDatePicker ename="contSignTime" cname="签订日期起"
				format="yyyy-MM-dd" parseFormats="['yyyy-MM-dd']" />
			<EF:EFDatePicker ename="contSignTime1" cname="签订日期止"
				format="yyyy-MM-dd" parseFormats="['yyyy-MM-dd']"/>
		</div>
	</EF:EFRegion>
	<EF:EFRegion id="result" title="合同变更管理">
...
<EF:EFWindow id="popData" url="" lazyload="true" width="95%" height="95%" title="变更合同信息"/>
