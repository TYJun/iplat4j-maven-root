        ...
        "result" : {
            ...
            loadComplete: function (grid) {
                ...
                $("#APPLYRZ").on("click", function(e) {
                    console.log("新增");
                    var url = IPLATUI.CONTEXT_PATH + "/web/DMXW0101";
                    var popData = $("#popData");
                ...
                $("#EDITINFO").on("click", function(e) {
                    ...
                    if (checkRows.length > 0) {
                        ...
                        console.log(id);
                        var url = IPLATUI.CONTEXT_PATH + "/web/DMXW0102?initLoad&id=" + id;
                ...
                $("#DELETEINFO").on("click", function(e) {
                    ...
                    if (checkRows.length > 0) {
                        var id = checkRows[0]["id"];
                        IPLAT.confirm({
                            message: '<b>将会删除该入住信息！</br><font color="red">是否确定？</font></b>',
                            okFn: function (e) {
                                //提交数据
                                var eiInfo = new EiInfo();
                                eiInfo.set("infoId", id);
                                resultGrid.removeRows(checkRows);
                                EiCommunicator.send("DMXW01", "deleteInfo", eiInfo, {
                        ...
                        NotificationUtil("请选择想要删除的信息", "warning")
                    }
                });
            }
        }
