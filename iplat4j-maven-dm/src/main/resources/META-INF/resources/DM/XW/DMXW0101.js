$(function () {
    ...
    $("#SUBMIT").unbind('click').on('click', function() {
        ...
        var note = IPLAT.EFInput.value($("#note")); /* 当前住址*/
        ...
        EiCommunicator.send("DMXW0101", "insert", eiInfo, {
...
$("#manNo").kendoAutoComplete({
    ...
    dataSource: dataSourceConfig("/service/DMXW01/queryPersonnelList", "person",["manNo"]),
    // blockId 下的属性 workNo
