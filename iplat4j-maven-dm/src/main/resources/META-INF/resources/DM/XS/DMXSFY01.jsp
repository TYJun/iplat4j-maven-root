...
<EF:EFPage title="宿舍费用管理">
	...
	<EF:EFRegion id="result" title="相关信息" fitHeight="true">
		<EF:EFGrid blockId="result" autoDraw="no" serviceName="DMXSFY01" checkMode="single,row" rowNo="true">
	...
	<EF:EFWindow id="popDataADD" url=" " lazyload="true" width="40%" height="75%" title="本月费用录入" modal="true" />
	...
	<EF:EFWindow id="execlImport" url="" lazyload="true" refresh="true" width="40%" height="50%">
		<EF:EFRegion id="fyUpload" title="宿舍费用导入">
			...
			<li>是否已退宿（必填; 是/否）</li>
			<li>月份（必填; 格式为“yyyy-mm”,例如:"2022-03"）</li>
