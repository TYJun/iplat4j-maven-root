...
<EF:EFPage title="宿舍综合查询">
	<EF:EFRegion id="inqu" title="查询区" showClear="true">
		...
		<div class="row">
			...
			<EF:EFSelect cname="状态"  ename="statusCode"
						 resultId="statusInfo" optionLabel="请选择" serviceName="DMZH01" methodName="queryStatusCodeInfo"
						 textField="codeName" valueField="codeNum" colWidth="4">
			</EF:EFSelect>
	...
	<EF:EFRegion id="result" title="相关信息" fitHeight="true">
		<EF:EFGrid blockId="result" autoDraw="no" serviceName="DMXSZH01" checkMode="single,row" rowNo="true">
			...
			<EF:EFColumn ename="actualInDate" cname="入住时间" readonly="true" width="100" align="center" />
			<EF:EFColumn ename="estimatedOutDate" cname="预计退宿时间" readonly="true" width="100" align="center" />
<%--			<EF:EFColumn ename="payStatusMean" cname="交钱环节" readonly="true" width="60" align="center" />--%>
	...
	<EF:EFWindow id="popDatashow" url="" lazyload="true" width="90%" height="90%" title="查看详情信息" modal="true" />
	<EF:EFWindow id="popDataEdit" url="" lazyload="true" width="50%" height="50%" title="编辑实际费用" modal="true" />
</EF:EFPage>