...
<EF:EFPage title="宿舍换宿审核">
	...
	<EF:EFRegion id="result" title="相关信息" fitHeight="true">
		<EF:EFGrid blockId="result" autoDraw="no" serviceName="DMXSHS02" checkMode="multiple,row" rowNo="true">
			...
			<EF:EFColumn ename="changeRoomNote" cname="changeRoomNote" readonly="true" hidden="true"/>
			<EF:EFColumn ename="applyChangeDate" cname="applyChangeDate" readonly="true" hidden="true"/>
			<EF:EFColumn ename="remainingBedNum" cname="剩余床位数" readonly="true" width="70" hidden="true"/>
			...
			<EF:EFColumn ename="changeRoomNote" cname="换宿备注" readonly="true" width="150"/>
			<EF:EFColumn ename="applyChangeDate" cname="申请时间" readonly="true" width="70" align="center" />
		</EF:EFGrid>
	</EF:EFRegion>
	<EF:EFWindow id="popData" url="" lazyload="true" width="90%" height="90%" title="直接分配" modal="true" />
</EF:EFPage>