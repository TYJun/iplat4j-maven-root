...
<EF:EFPage>
	<EF:EFRegion id="result" title="信息详情">
		<div class="row">
			...
			<EF:EFInput ename="manId" cname="manId" readOnly="true"
						colWidth="4" type="hidden"/>
		...
		<div class="row">
			<EF:EFInput ename="evalContent" cname="意见和建议" placeholder="可在此处对入住体验给予意见和建议！"
						colWidth="8" rows="3" ratio="2:10" type="textarea" />
		</div>
	</EF:EFRegion>
</EF:EFPage>