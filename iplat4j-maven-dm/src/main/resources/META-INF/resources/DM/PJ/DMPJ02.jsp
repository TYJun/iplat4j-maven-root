...
<EF:EFPage title="宿舍满意度评价项目管理">
	<div class="row">
		<div class="col-md-2">
			<EF:EFRegion id="tree" title="评价项目分类" fitHeight="true">
				<EF:EFTree id="menu" valueField="id" textField="classifyName" hasChildren="hasChildren" serviceName="DMPJ02" methodName="queryTypeTree" style="height:660px;"/>
		...
		<div class="col-md-10">
			<EF:EFRegion id="inqu" title="查询区">
				<div class="row">
					...
					<EF:EFInput ename="itemName" cname="项目名称" />
					<EF:EFInput ename="typeId" cname="评价项目id" type="hidden"/>
				</div>
				
			</EF:EFRegion>
			<EF:EFRegion id="result" title="数据集" fitHeight="true">
				<EF:EFGrid blockId="result" autoDraw="no" serviceName="DMPJ02" rowNo="true">
			...
			<EF:EFWindow id="popData" url="" lazyload="true" width="35%" height="36%" title="评价项目新增" modal="true" />
			<EF:EFWindow id="popDataEdit" url="" lazyload="true" width="35%" height="36%" title="评价项目修改" modal="true" />
		</div>
	</div>
</EF:EFPage>