...
<title>宿舍管理员评价页面</title>
<EF:EFPage title="宿舍管理员评价">
	...
	<EF:EFRegion id="result" title="相关信息" fitHeight="true">
		<EF:EFGrid blockId="result" autoDraw="no" serviceName="DMPJ03" rowNo="true" checkMode="single,row">
			...
			<EF:EFColumn ename="countEval" cname="评价次数" readonly="true" width="60" align="center" />
		</EF:EFGrid>
	</EF:EFRegion>
	<EF:EFWindow id="popData" url="" lazyload="true" width="40%"
				 height="40%" title="填写评价内容" />
	<EF:EFWindow id="popDataShow" url="" lazyload="true" width="60%"
				 height="60%" title="查看评价履历" />
</EF:EFPage>