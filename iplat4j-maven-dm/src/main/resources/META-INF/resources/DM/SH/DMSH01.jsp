...
<EF:EFPage title="宿舍入住审核">
	...
	<EF:EFRegion id="result" title="申请信息" fitHeight="true">
		<EF:EFGrid blockId="result" autoDraw="no" serviceName="DMSH01" checkMode="multiple,row" rowNo="true">
			...
			<EF:EFColumn ename="academicYear" cname="学年制" readonly="true"  width="60" align="center"/>
