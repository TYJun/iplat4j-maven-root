...
<EF:EFPage title="批量发送短信">
	...
	<EF:EFRegion id="result" title="申请信息" fitHeight="true">
		<EF:EFGrid blockId="result" autoDraw="no" serviceName="DMDX01" checkMode="multiple,row" rowNo="true">
			<EF:EFColumn ename="id" cname="id" readonly="true" hidden="true"   />
			<EF:EFColumn ename="roomManId" cname="roomManId" readonly="true" hidden="true"   />
			...
			<EF:EFColumn ename="roomName" cname="宿舍名称" readonly="true" width="120" align="center"/>
			...
			<EF:EFColumn ename="maritalStatus" cname="婚姻状况" readonly="true"  width="80" align="center"/>
	...
	<EF:EFWindow id="popData" url="" lazyload="true" width="60%" height="90%" title="编辑短信模板" modal="true" />
</EF:EFPage>