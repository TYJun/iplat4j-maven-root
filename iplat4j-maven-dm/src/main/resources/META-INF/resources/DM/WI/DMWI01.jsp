...
<EF:EFPage title="宿舍待入住管理">
			<EF:EFRegion id="inqu" title="查询区" showClear="true">
				<div class="row">
    				...
    				<EF:EFSelect ename="ifReview" cname="审批状态"  readonly="true" defaultValue="1" >
			...
			<EF:EFRegion id="result" title="待入住信息" fitHeight="true" >
			...
			<EF:EFWindow id="popData" url="" lazyload="true" width="60%" height="90%" title="分配房间" modal="true" />
...
$(function() {
	...
	//分配按钮
	$("#ALLOCATION").on("click", function(e) {
		 if (datagrid == null) {
				IPLAT.alert("请先选择一条记录进行操作");
			} else {
				var url = IPLATUI.CONTEXT_PATH + "/web/DMWI0101?initLoad&type=edit&id="+datagrid.id;
				var popData = $("#popData");
