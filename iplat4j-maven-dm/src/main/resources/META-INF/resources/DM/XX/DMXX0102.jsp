...
<%--	</style>--%>
	<EF:EFRegion id="result" title="宿舍信息" fitHeight="false">
		<div class="row">
			...
			<EF:EFInput ename="roomId" cname="主键" colWidth="5" type="hidden" readonly="true" />
	...
	<EF:EFTab id="tab-tab_grid" active="0">
		<div title="宿舍物资信息">
			<EF:EFRegion id="results" title="宿舍物资信息">
				<EF:EFGrid blockId="results"  autoDraw="no" checkMode="single,row" readonly="false" rowNo="true" >
