 ...
 */
public class ServiceDMXSSH01 extends ServiceBase{
	 ...
	 * 3、调用本地RZ模块的服务DMRZ01.queryRZInfoList()方法进行列表数据查询.
	 * @param inInfo
	 * @return
	 */
...
//		inInfo.set("statusCode", "00");
	 ...
	 *
	 * 1、获取参数的值、实例化 manIdList；
	 * 2、接收来的数据有一个数值(**)或多个数值并逗号隔开(**,**)两种形式,所以要分别进行判断操作；
	 * 3、新建一个map用来存放获取的数据；
	 * 4、以map作为参数执行 DMSH01.selectStudent 查询当前申请中包含的全日制学生，提取出给前端做提醒；
	 * 5、返回一个EiInfo.
	 * @param inInfo
	 * @return
	 */
