 ...
 */
public class ServiceDMXSQR01 extends ServiceBase {
    /**
     * 初始化设置statusCode为03
     * 调用query方法查询用户信息
     * @param inInfo
     ...
     * 3.调用本地服务DMQR01.queryQRInfoList()方法进行列表数据查询.
     * @param inInfo
     * @return
     */
    ...
    /**
     * 根据前端录入的工号、姓名、科室部门、宿舍楼、宿舍层、房间号、人员大类查询符合条件的宿舍确认入住信息
     * 1、将要查询的参数组成数组并调用工具类转换参数
     * 2、额外角色参数进行处理
     * 3、该页面住宿人不可见，故无需兼顾住宿人角色.
     * 4、调用本地DMQR01.queryShouldConfirmList方法查询数据
     * @param inInfo
     * @return
     */
