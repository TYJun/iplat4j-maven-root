...
/**
* DormsSatisfactionItemclass
* 
*/
public class DormsSatisfactionItemclass extends DaoEPBase {

    private static final long serialVersionUID = 1L;

    private String id = " ";		/* 主键*/
    private String classifyCode = " ";		/* 项目分类编码*/
    private String classifyName = " ";		/* 项目分类名称*/
     ...
     * the constructor
     */
    public DormsSatisfactionItemclass() {
        initMetaData();
    }
