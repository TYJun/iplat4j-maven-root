 ...
 */
public class ServiceDMXSXF01 extends ServiceBase {
    /**
     * 此方法用于宿舍在线选房页面初始化加载
     *
     * 逻辑处理：
    ...
    /**
     * 查询宿舍在线选房信息
     * 1、判断账号是否为空，为空则提示账号存在问题
     * 2、将要查询的参数组成数组并调用工具类转换参数；
     * 3、获取当前登录人的用户角色，根据用户角色对view赋予它的角色值，以便后续查工单列表的时候做数据显示角色区分；
     * 4、判断人员大类的选择；
     * 5、调用DMXF01.queryAllCanChoose查询选房信息
     * @param inInfo
     * @return
     */
    ...
    public EiInfo query(EiInfo inInfo) {
        ...
        map.put("roomId",inInfo.getString("roomId"));
        /*
         * 5、调用DMXF01.queryAllCanChoose查询信息
         */
...
//    }
    ...
    /**
     * 查询可选房的楼
     * 1、从前端获取workNo，判断账号是否存在问题；
     * 2、从前端获取角色信息，根据ADMIN、DMSPR给角色赋值；
     * 3、调用DMXF01.queryCanSelectBuilding方法，查询相关信息。
     * @param inInfo
     * @return
     */
     ...
     * 1、从前端获取workNo，判断账号是否存在问题；
     * 2、从前端获取角色信息，根据ADMIN、DMSPR给角色赋值；
     * 3、调用DMXF01.queryCanSelectFloor方法，查询相关信息。
     * @param inInfo
     * @return
     */
    ...
    public EiInfo queryCanSelectRoomNo(EiInfo inInfo) {
        ...
        EiInfo outInfo = new EiInfo();
        /*
         * 3、调用DMXF01.queryCanSelectRoomSpot方法，查询相关信息
         */
