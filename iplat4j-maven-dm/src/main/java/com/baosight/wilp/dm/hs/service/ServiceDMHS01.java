 ...
 */
public class ServiceDMHS01 extends ServiceBase {
    private static final Logger logger = LoggerFactory.getLogger(ServiceDMHS01.class);
    /**
     * 页面内查询接口.
     ...
     * 2、处理app端角色权限的参数
     * 3、对额外的参数进行处理.
     * 4.调用sql方法DMHS01.queryCanChangeList查询换宿申请信息
     *
