 ...
 */
public class ServiceDMZH01 extends ServiceBase {
    /**
     * 页面内查询接口.
     ...
     *    2.处理app端角色权限的参数 对应的角色对应对应的限制：管理员权限不做限制，普通角色只能看见自己的信息
     *    3.对额外的参数进行处理 role方法传来的查看角色值
     *    4.调用DMZH01.queryZHList查询宿舍综合页面信息
     *    5.判断是否存在，存在则构建返回对象 并设置状态和返回信息
     *
     * @Title: queryZHInfoList
     * @param inInfo
     * @return: EiInfo
     */
