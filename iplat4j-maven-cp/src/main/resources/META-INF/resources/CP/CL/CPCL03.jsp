...
<EF:EFPage>
	...
	<EF:EFRegion id="result" title="科室处理管理">
		<EF:EFGrid blockId="result" needAuth="true" autoDraw="no" autoBind="true" autoFit="true"
			...
			<EF:EFColumn ename="dealWorkName" cname="处理人" width="100" align="center" hidden="true"/>
			<EF:EFColumn ename="dealDate" cname="处理日期" width="100" align="center" hidden="true"/>
...
<EF:EFWindow id="popData2" title="科室处理登记" url=" " lazyload="true" width="100%" height="100%"></EF:EFWindow>