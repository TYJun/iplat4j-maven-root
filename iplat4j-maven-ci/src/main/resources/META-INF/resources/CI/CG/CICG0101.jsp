...
<EF:EFPage>
	...
	<EF:EFRegion id="result" title="采购入库物资信息">
		<EF:EFGrid blockId="result" autoDraw="no"  height="400" checkMode="row">
			...
			<EF:EFColumn ename="price" cname="价格" width="60" enable="false" align="center"/>
		</EF:EFGrid>
	</EF:EFRegion>
</EF:EFPage>
<EF:EFWindow id="popData1" title="物资选择" url=" " lazyload="true" width="90%" height="92%"></EF:EFWindow>
<EF:EFWindow id="popDataCY" title="常用物资选择" url=" " lazyload="true" width="90%" height="92%"></EF:EFWindow>