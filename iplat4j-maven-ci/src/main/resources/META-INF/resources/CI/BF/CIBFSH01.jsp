...
<EF:EFPage title="报废出库审核管理">
    ...
    <EF:EFRegion id="result" title="报废出库审核管理" >
        <EF:EFGrid blockId="result" autoDraw="no" checkMode="single,row" readonly="false" rowNo="true">
            <EF:EFColumn ename="id" cname="主键" hidden="true" />
            <EF:EFColumn ename="outBillNo" cname="申请单号" readonly="true" align="center"/>
            <EF:EFColumn ename="billMakerName" cname="申请人" readonly="true" align="center"/>
    ...
    <EF:EFWindow id="popData" url="" lazyload="true"  width="90%" height="92%" title="报废出库审核管理" modal="true" />
    <EF:EFWindow id="popDataModify" url="" lazyload="true"  width="90%" height="92%" title="报废出库申请" modal="true" />
</EF:EFPage>