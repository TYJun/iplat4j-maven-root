...
<EF:EFPage>
	<EF:EFRegion id="inqu" title="采购入库信息">
		<div class="row">
			<EF:EFPopupInput ename="canteen" cname="科室：" colWidth="4"
							 popupType="ServiceGrid" popupTitle="科室:" required="true" serviceName="CIRK01"
			...
			<%--<EF:EFCascadeSelect ename="inqu_status-0-canteenNum" autoBind="true"
								cname="食堂名称" textField="canteenName" valueField="canteenCode"
