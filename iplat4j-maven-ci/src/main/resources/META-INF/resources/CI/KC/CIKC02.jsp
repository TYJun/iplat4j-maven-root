...
<EF:EFPage>
	<EF:EFRegion id="inqu" title="查询条件" showClear="true">
		<div class="row">
			...
			<EF:EFSelect ename="inqu_status-0-originBillTypeName" cname="来源单据类型">
				<EF:EFOption label="全部" value=""/>
				<EF:EFCodeOption codeName="wilp.ci.originBillType"/>
			</EF:EFSelect>
	...
	<EF:EFRegion id="result" title="库存操作履历信息">
		<EF:EFGrid blockId="result" autoDraw="no" checkMode="single,row" autoBind="true" readonly="true">
			...
			<EF:EFColumn ename="originBillTypeName" cname="来源单据类型" width="100" align="center"/>
			<EF:EFColumn ename="recCreateTime" cname="制单日期" width="100" align="center"/>
			...
			<EF:EFColumn ename="beforeNum" cname="操作前数量" width="80" align="center"/>
			<EF:EFColumn ename="beforeAmount" cname="操作前总价" width="80" align="center"/>
			<EF:EFColumn ename="afterNum" cname="操作后数量" width="80" align="center"/>
			<EF:EFColumn ename="afterAmount" cname="操作后总价" width="80" align="center"/>
		</EF:EFGrid>
	</EF:EFRegion>
</EF:EFPage>