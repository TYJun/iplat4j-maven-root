...
<EF:EFPage>
		...
		<EF:EFRegion id="result" title="物质列表">
			<EF:EFGrid blockId="result" autoDraw="no" autoBind="true" checkMode="row" readonly="true" height="330">
				<EF:EFColumn ename="matNum" cname="物资编码" width="60" align="center"/>
				<EF:EFColumn ename="matName" cname="物资名称" width="60" align="center"/>
				<EF:EFColumn ename="matTypeName" cname="物资分类" width="60" align="center"/>
				<EF:EFColumn ename="matModel" cname="物资型号" width="60" align="center"/>
				<EF:EFColumn ename="matSpec" cname="物资规格" width="60" align="center"/>
				<EF:EFColumn ename="unit" cname="单位" width="60" hidden="true" />
				<EF:EFColumn ename="unitName" cname="物资单位" width="60" align="center"/>
				<EF:EFColumn ename="totalNum" cname="当前数量" width="60" align="center"/>
			</EF:EFGrid>
		</EF:EFRegion>
</EF:EFPage>