 ...
 * @Title:  ServiceCIYJ01.java
 * @ClassName:  ServiceCIYJ01
 * @Package com.baosight.wilp.ci.yj.service
 * @Description: TODO
 * @author fangjian
 ...
 *
 */
public class ServiceCIYJ03 extends ServiceBase {
    ...
    public EiInfo query(EiInfo inInfo) {
		...
		inInfo.set("inqu_status-0-expirationDate", DateUtils.curDateStr10());
		return super.query(inInfo, "CIYJ01.query", new CiStorgeDetail());
    }
    ...
    public EiInfo delete(EiInfo inInfo) {
    	 return  super.update(inInfo, "CIYJ01.delete");
    }
