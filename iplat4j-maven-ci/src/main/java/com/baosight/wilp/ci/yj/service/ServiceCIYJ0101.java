 ...
 * @Title:  ServiceCIYJ0101.java
 * @ClassName:  ServiceCIYJ0101
 * @Package com.baosight.wilp.ci.yj.service
 * @Description: TODO
 * @author fangjian
 ...
 *
 */
public class ServiceCIYJ0101 extends ServiceBase {
    ...
    public EiInfo initLoad(EiInfo inInfo) {
		...
		if("edit".equals(type)) {
			inInfo.set("inqu_status-0-id", inInfo.getString("id"));
