...
import com.baosight.wilp.ci.cg.domain.CiApplyDetail;
...
public class ServiceCICG0102 extends ServiceBase {
    ...
    public EiInfo initLoad(EiInfo inInfo) {
        ...
        inInfo.set("dept_textField", inInfo.get("deptName"));
        List<CiApplyDetail> list = dao.query("CICG0101.query", pMap);
        return CommonUtils.BuildOutEiInfo(inInfo, "result", new CiApplyDetail().eiMetadata, list, list.size());
    }
    ...
    public EiInfo update(EiInfo eiInfo) {
        ...
        //删除之前的物资
        dao.delete("CICG0101.delete" ,applyBillNo);
        //获取当前物资信息
