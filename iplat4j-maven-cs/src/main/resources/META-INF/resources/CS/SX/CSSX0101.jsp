...
<EF:EFPage title="保洁事项新增">
	<EF:EFRegion id="ADD">
		<div class="row">
			<EF:EFInput ename="moduleId" cname="事项分类id" colWidth="5"
				type="hidden" />
			<EF:EFInput ename="id" cname="事项主键" colWidth="5" type="hidden" />
			...
			<EF:EFPopupInput ename="serDeptName" cname="服务科室" colWidth="5"
			    popupHeight="575" popupWidth="550"
				popupTitle="科室选择" required="true" readOnly="true"
				popupType="ServiceGrid" serviceName="CSRE01" methodName="queryServerDept"
