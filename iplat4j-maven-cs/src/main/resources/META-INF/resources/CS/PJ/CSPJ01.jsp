...
<EF:EFPage title="工单评价">
    ...
    <EF:EFRegion id="result" title="工单列表">
    	<EF:EFGrid blockId="result" autoDraw="no" autoBind="true" readonly="true" checkMode="multiple,row" serviceName="CSPJ01">
    	    ...
    	    <EF:EFColumn ename="comments" cname="备注"  align="center" width="100"/>
			...
			<EF:EFColumn ename="finishUserName" cname="完工人"   align="center" width="100"/>
            <EF:EFColumn ename="finishTime" cname="完工时间"   align="center" width="100"/>
    	</EF:EFGrid>
    </EF:EFRegion>
    <EF:EFWindow id="popData" url="" lazyload="true" width="80%" height="80%" title="工单评价管理" modal="true" />
