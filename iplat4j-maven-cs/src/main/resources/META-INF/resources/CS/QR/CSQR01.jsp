...
<EF:EFPage title="工单确认">
    ...
    <EF:EFRegion id="result" title="工单列表">
    	<EF:EFGrid blockId="result" autoDraw="no" autoBind="true" readonly="true" checkMode="multiple,row" serviceName="CSQR01">
    ...
    <EF:EFWindow id="popData" url="" lazyload="true" width="80%" height="80%" title="工单确认管理" modal="true" />
