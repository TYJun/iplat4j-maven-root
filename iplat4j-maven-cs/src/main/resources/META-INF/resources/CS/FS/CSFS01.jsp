...
<EF:EFPage title="工单完工">
    ...
    <EF:EFRegion id="result" title="工单列表">
    	<EF:EFGrid blockId="result" showCount="false" autoDraw="no" autoBind="true" readonly="true" checkMode="multiple,row" serviceName="CSFS01">
			...
			<EF:EFColumn ename="confirmUserName" cname="确认人"   align="center" width="100"/>
            <EF:EFColumn ename="confirmTime" cname="确认时间"   align="center" width="100"/>
    	</EF:EFGrid>
    </EF:EFRegion>
    <EF:EFWindow id="popData" url="" lazyload="true" width="80%" height="80%" title="工单完工管理" modal="true" />
