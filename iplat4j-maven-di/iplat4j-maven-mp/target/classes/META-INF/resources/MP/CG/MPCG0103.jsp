...
<EF:EFPage>
	<EF:EFRegion id="inqu" title="采购计划">
		<div class="row">
			...
			<EF:EFInput ename="inqu_status-0-recCreateTime" cname="创建日期" readonly="true" type="hidden"/>
			<EF:EFInput ename="inqu_status-0-recCreator" cname="创建人" readonly="true" type="hidden"/>
			<EF:EFInput ename="inqu_status-0-purchaseNo" cname="被拆分采购计划单号" readonly="true"/>
		</div>
	</EF:EFRegion>
	<EF:EFRegion id="result" title="采购计划明细列表">
		<EF:EFGrid blockId="result" autoDraw="no" checkMode="single,row" autoBind="true"  rowNo="true">
			...
			<EF:EFColumn ename="unit" cname="计量单位" width="100" align="center" enable="false"/>
