...
<%--合同变更子页面--%>
<EF:EFPage>
    <EF:EFRegion id="inqu" title="变更" fitHeight="false">
        <div class="row">
            <EF:EFInput ename="inqu_status-0-id" cname="主键" type="hidden"/>
            <EF:EFInput ename="inqu_status-0-dockContId" cname="对接合同ID" type="hidden"/>
            <EF:EFInput ename="inqu_status-0-statusCode" cname="状态编码" type="hidden"/>
            <EF:EFInput ename="inqu_status-0-statusName" cname="状态名称" type="hidden"/>
        ...
        <div class="row">
            <EF:EFInput ename="inqu_status-0-contNo" cname="合同号" required="true" readonly="true"/>
            <EF:EFInput ename="inqu_status-0-contName" cname="合同名称" required="true" readonly="true"/>
    ...
    <EF:EFTab id="tab-tab_grid" active="0">
        ...
        <div title="合同附件">
            <EF:EFGrid blockId="file" needAuth="true" autoDraw="no" autoBind="true" autoFit="true"
                ...
                <EF:EFColumn ename="recCreateTime" cname="上传时间" width="200" align="center"/>
            </EF:EFGrid>
        </div>
    </EF:EFTab>
