 ...
 * <desc>    // 描述修改内容
 */
public class ServiceDIJZ02 extends ServiceBase{
    ...
    public EiInfo initLoad(EiInfo inInfo) {
        EiInfo query = super.query(inInfo, "DIJZ02.query", new DiDevicePacket());
        return query;
    }
    ...
    public EiInfo delete(EiInfo inInfo) {
        ...
        //删除设备包信息
        int delete = dao.delete("DIJZ02.deleteInspection", ids);
       //循环删除设备包明细
        for (String id : ids) {
            dao.delete("DIJZ02.deleteRelation", id);//删除设备包明细
        }
    ...
    public EiInfo update(EiInfo inInfo) {
        ...
        list.forEach(id -> {
            ...
            param.put("id", id);
            dao.update("DIJZ02.updateStatus", param);
        });
