 ...
 */
public class ServiceDIJZ020101 extends ServiceBase {
    ...
    public EiInfo initLoad(EiInfo inInfo) {
        EiInfo outInfo = super.query(inInfo, "DIJZ020101.query", new DiDevicePacket());
        return outInfo;
    }
    ...
    public EiInfo query(EiInfo info) {
        ...
        map.put("limit", limit);
        List<DiDevicePacket> query = dao.query("DIJZ020101.query", map);
        //封装参数返回
