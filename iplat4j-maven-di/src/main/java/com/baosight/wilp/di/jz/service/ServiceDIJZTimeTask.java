...
public class ServiceDIJZTimeTask extends ServiceBase {

    private static int prepareCreateTime = 24;
    ...
    public EiInfo createTask(EiInfo inInfo) {
    ...
    private void updateSchemeCyc(Map<String, String> map) {
        ...
        dao.update("DIJZ01.updateDeviceCyc", map);
    }
    ...
    //@Scheduled(cron = "* */5 * * * ?")
    public EiInfo timeOutTask(EiInfo inInfo) {
    	dao.update("DIZH01.changeStatus",null);
        return inInfo;
    }
}
