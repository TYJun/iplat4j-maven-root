...
import com.baosight.wilp.di.jz.domain.DfClassfyparam;
import com.baosight.wilp.di.jz.domain.DiDevicePacket;
 ...
 * <desc>    // 描述修改内容
 */
public class ServiceDIJZ0202 extends ServiceBase{
    ...
    public EiInfo initLoad(EiInfo inInfo) {
        ...
        //查询巡检包信息
        List<DiDevicePacket> query = dao.query("DIJZ0202.query", id);
        ...
        //查询巡检包项目信息
        List<DiDevicePacket> query2 = dao.query("DIJZ0202.queryDetail", map2);
        ...
        addBlock2.addBlockMeta(new DiDevicePacket().eiMetadata);
        outInfo.getBlock("inqu").setRows(query);

        DiDevicePacket diDevicePacket = query.get(0);
        ...
        result.addBlockMeta(new DiDevicePacket().eiMetadata);
    ...
    public EiInfo upda(EiInfo inInfo) {
        ...
        //先删除设备包明细表中信息
        int delete = dao.delete("DIJZ0202.deleteDetail", dIJZID);
        ...
        map.put("id", DIJZID);
        dao.update("DIJZ0202.updateInspection", map);
        ...
        for (Map<String, String> map2 : removeDuplicate) {
            ...
            dao.insert("DIJZ0202.insertPackDetail", mapDetail);
        }
        DIJZID = null;
        return inInfo;
    }
