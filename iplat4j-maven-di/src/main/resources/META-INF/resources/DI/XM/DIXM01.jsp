...
<EF:EFPage title="巡检项目管理">
	<div class="row">
		<div class="col-md-2">
			<EF:EFRegion id="tree" title="巡检项目分类" fitHeight="true">
				<EF:EFTree id="menu" valueField="id" textField="classifyName" hasChildren="hasChildren" serviceName="DIXM01" methodName="queryTypeTree" style="height:660px;"/>
		...
		<div class="col-md-10">
			<EF:EFRegion id="inqu" title="查询区">
				<div class="row">
					...
					<EF:EFInput ename="itemName" cname="巡检项目" />
			...
			<EF:EFWindow id="popData" url="" lazyload="true" width="35%" height="36%" title="巡检项目新增" modal="true" />
			<EF:EFWindow id="popDataEdit" url="" lazyload="true" width="35%" height="36%" title="巡检项目修改" modal="true" />
		</div>
	</div>
</EF:EFPage>