...
<EF:EFPage title="巡检实绩维护">
	<EF:EFRegion id="EDIT" title="基本信息">
		<div class="row">
			...
			<EF:EFInput ename="schemeDept" cname="巡检单位" colWidth="4" type="text" required="true" readonly="true"/>
			<EF:EFInput ename="schemeMan" cname="巡检管理人" colWidth="4" type="text" required="true" readonly="true"/>
		</div>
	</EF:EFRegion>
	<EF:EFRegion title="作业说明">
		<div class="row padding20">
			<EF:EFInput colWidth="12" ratio="0:12" type="textarea" ename="jobContent" rows="3" readonly="true"></EF:EFInput>
		</div>
	</EF:EFRegion>
		
	<EF:EFRegion title="巡检项目">
		<EF:EFGrid blockId="item" autoDraw="no" serviceName="DISJ0101">
			...
			<EF:EFColumn ename="content" align="center" cname="巡检项目" enable="false" width="60"/>
			...
			<EF:EFColumn ename="writeValue" align="center" cname="巡检结果" width="120"/>
