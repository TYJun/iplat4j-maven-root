...
<EF:EFPage title="巡检实绩查询">
	<EF:EFRegion id="inqu" title="查询区">
		<div class="row">
			...
			<EF:EFInput ename="schemeDept" cname="巡检单位" colWidth="3"/>
			</div>
		<div class="row">
	...
	<EF:EFRegion id="result" title="数据集" fitHeight="true">
		<EF:EFGrid blockId="result" autoDraw="no" serviceName="DISJ01">
			...
			<EF:EFColumn ename="deptName" cname="巡检单位 " readonly="true"  width="100" align="center"/>
			<EF:EFColumn ename="name" cname="巡检管理人" readonly="true" align="center" width="80"/>
