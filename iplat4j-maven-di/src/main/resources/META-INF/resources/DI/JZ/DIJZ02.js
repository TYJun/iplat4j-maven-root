			...
			"result": {
				loadComplete: function (grid) {
					$("#ADD").on("click", function (e) {
						var url = IPLATUI.CONTEXT_PATH + "/web/DIJZ0201?operType=add";
						var popData = $("#popData");
					...
					$("#EDIT").on("click", function (e) {
						...
						var url = IPLATUI.CONTEXT_PATH + "/web/DIJZ0202?operType=update&id="+id;
					...
					$("#DELETEROW").on("click", function (e) {
						...
						var info=new EiInfo();
						info.set("idList",arr);
						EiCommunicator.send("DIJZ02", "delete", info, {
					...
					$("#START").on("click", function (e) {
						...
						info.set("list",arr);
						info.set("code",1);
						EiCommunicator.send("DIJZ02", "update", info, {
							onSuccess : function(ei) {
								NotificationUtil(ei.getMsg(), "success");
								resultGrid.dataSource.page(1);
							}
