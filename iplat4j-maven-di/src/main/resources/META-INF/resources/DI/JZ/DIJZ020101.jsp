...
<EF:EFPage>
	...
	<EF:EFRegion  title="问题信息">
		<EF:EFGrid blockId="result" autoDraw="no" readonly="true">
			<EF:EFColumn ename="deviceId" cname="主键" hidden="true" align="center" />
