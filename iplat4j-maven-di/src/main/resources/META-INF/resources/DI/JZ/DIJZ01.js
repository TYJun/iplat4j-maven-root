			...
			"result": {
				loadComplete: function (grid) {
					$("#ADD").on("click", function (e) {
						var url = IPLATUI.CONTEXT_PATH + "/web/DIJZ0101?operType=add";
						var popData = $("#popData");
					...
					$("#EDIT").on("click", function (e) {
						...
						var url = IPLATUI.CONTEXT_PATH + "/web/DIJZ0101?operType=update&id="+id;
					...
					$("#DELETEROW").on("click", function (e) {
						...
						var info=new EiInfo();
						info.set("list",arr);
						EiCommunicator.send("DIJZ01", "deleteScheme", info, {
					...
					$("#START").on("click", function (e) {
						...
						var info=new EiInfo();
						info.set("list",arr);
						EiCommunicator.send("DIJZ01", "startScheme", info, {
							onSuccess : function(ei) {
								NotificationUtil(ei.getMsg(), "success");
								resultGrid.dataSource.page(1);
							}
					...
					$("#STOP").on("click", function (e) {
						...
						var info=new EiInfo();
						info.set("list",arr);
						EiCommunicator.send("DIJZ01", "stopScheme", info, {
							onSuccess : function(ei) {
								NotificationUtil(ei.getMsg(), "success");
								resultGrid.dataSource.page(1);
							}
