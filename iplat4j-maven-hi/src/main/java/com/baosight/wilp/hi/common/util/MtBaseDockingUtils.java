...
public class MtBaseDockingUtils {
...
//		String templateCode = MTUtils.getMtConfigValueText("dxTemplateCode");
//		List<String> paramList = new ArrayList<>();
//		paramList.add(smsContent);
//		System.out.println("维修短信参数：workNoList:"+list.toString()+",paramList:"+paramList.toString()+"templateCode:"+templateCode);
...
//		String templateCode = MTUtils.getMtConfigValueText("tsTemplateCode");
//		List<String> list = listChange(recvList);
//		List<String> paramList = new ArrayList<>();
//		paramList.add(smsContent);
//		System.out.println("维修消息推送参数：workNoList:"+list.toString()+",paramList:"+paramList.toString()
