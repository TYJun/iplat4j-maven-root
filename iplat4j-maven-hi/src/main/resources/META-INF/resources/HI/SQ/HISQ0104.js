...
// 开启校验
    ...
    /* 分页处理 */
        ...
        $("#PASS").on("click", function () {
            ...
            var emo = IPLAT.EFInput.value($("#inqu_status-0-emo1"));
            ...
            //提交
            EiCommunicator.send("HISQ0104", "evaluationPass", eiInfo, {
                onSuccess: function (ei) {
                    closeCurrentWindow();
  ...
  //驳回
    $("#OVERRULE").on("click", function () {
        ...
        if(validate(emo)) {
            ...
            //提交
            EiCommunicator.send("HISQ0104", "evaluationOverrule", eiInfo, {
                onSuccess: function (ei) {
