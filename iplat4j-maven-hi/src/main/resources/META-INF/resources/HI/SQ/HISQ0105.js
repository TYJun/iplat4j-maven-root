...
// 开启校验
    ...
    /* 分页处理 */
        ...
        $("#PASS").on("click", function () {
            ...
            var emo = IPLAT.EFInput.value($("#inqu_status-0-emo2"));
            ...
            //提交
            EiCommunicator.send("HISQ0105", "evaluationPass", eiInfo, {
                onSuccess: function (ei) {
                    closeCurrentWindow();
  ...
  //驳回
    $("#OVERRULE").on("click", function () {
        ...
        if(validate(emo)) {
            ...
            //提交
            EiCommunicator.send("HISQ0105", "evaluationOverrule", eiInfo, {
                onSuccess: function (ei) {
