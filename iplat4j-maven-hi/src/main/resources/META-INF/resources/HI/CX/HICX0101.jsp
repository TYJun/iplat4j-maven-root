...
<EF:EFPage>
    <EF:EFRegion id="result" title="登记" fitHeight="false">
        <div class="row">
            ...
            <EF:EFInput ename="inqu_status-0-iconNum" cname="标识单号" type="hidden"/>
        ...
        <div class="row">
            <div class="col-md-5">
                <div class="form-group">
                    <label for="iconName" class="col-xs-4 control-label">标识名称</label>
                    <div class = "col-xs-8">
                        <input id="applyNo" name="applyNo"  placeholder="申请单号" type="hidden">
                        <input id="iconName" name="iconName"  ondblclick="showAll('iconName')">
                        <EF:EFButton cname="选择" ename="selectItem" layout="1" class="k-button"></EF:EFButton>
                    </div>
                </div>
            </div>
        </div>
        ...
        <div class="row">
            ...
            <EF:EFPopupInput ename="inqu_status-0-spotName" cname="安装地方" colWidth="5" ratio="4:8" readonly="true" popupWidth = "550"
        ...
        <div class="row">
            <EF:EFPopupInput ename="inqu_status-0-deptName" cname="使用科室"
    ...
    <EF:EFTab id="tab-tab_grid" active="0">
        <div title="标识标准">
            <EF:EFGrid blockId="resultD" needAuth="true" autoDraw="no" autoBind="true" autoFit="true"
                ...
                <EF:EFColumn ename="standardNum" cname="标准编码" width="100" />
                <EF:EFColumn ename="standardName" cname="标准名称" width="200" />
...
<%--   标识名称弹出框--%>
    <EF:EFWindow id="itemChoose" url="" lazyload="true" refresh="true" width="60%" height="50%">
        <iframe frameborder="0" name="device" class="k-content-frame" src="${ctx}/web/HIXX0102"></iframe>
    </EF:EFWindow>

</EF:EFPage>
<EF:EFWindow id="popWorldData" url=" " title="医院标识信息" lazyload="true" width="90%" height="90%"></EF:EFWindow>
<script type="text/javascript" src="${pageContext.request.contextPath}/bpm/Message.js"></script>
<script type="text/javascript" src="${ctx}/HI/XX/JS/hixx_detail_utils.js"></script>
