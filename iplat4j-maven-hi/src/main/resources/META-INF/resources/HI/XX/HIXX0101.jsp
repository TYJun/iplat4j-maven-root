...
<EF:EFPage>
    <EF:EFRegion id="result" title="登记" fitHeight="false">
        <div class="row">
            ...
            <EF:EFInput ename="inqu_status-0-recCreateTime" cname="创建日期" colWidth="5" ratio="4:8" readonly="true"
                        type="hidden"/>
        ...
        <div class="row">
            ...
            <EF:EFInput ename="inqu_status-0-spotName" colWidth="5" ratio="4:8" cname="地点名称" />
...
<%--            <EF:EFInput ename="inqu_status-0-spotName" type="hidden" cname="地点名称" />--%>
        ...
        <div class="row">
            <EF:EFPopupInput ename="inqu_status-0-deptName" cname="使用科室"
                             popupTitle="标识所属部门" popupType="ServiceGrid" serviceName="HISQ0101"
