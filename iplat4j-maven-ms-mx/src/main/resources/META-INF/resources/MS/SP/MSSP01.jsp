...
<EF:EFPage>
    <div class="col-md-3">
        <EF:EFRegion id="R1" title="系统名称" fitHeight="true">
            <EF:EFTree id="tree01" textField="text" valueField="label"
                       hasChildren="leaf" serviceName="MSSP01" methodName="queryTree">
            </EF:EFTree>
        </EF:EFRegion>
    </div>
    <div class="col-md-9">
        <EF:EFRegion id="inqu" title="查询条件" showClear="true">
            <div class="row">
                <EF:EFInput ename="inqu_status-0-monitorName" cname="视频名称" />
                <EF:EFInput ename="inqu_status-0-parentId" cname="" />
            </div>
        </EF:EFRegion>
        <br/>
        <EF:EFRegion id="result" title="系统分类">
            <EF:EFGrid blockId="result" autoDraw="no" checkMode="single">
                ...
                <EF:EFColumn ename="monitorName" cname="视频名称" width="200" disabled="true"/>
                <EF:EFColumn ename="monitorCode" cname="视频编号" width="200" disabled="true"/>
            </EF:EFGrid>
        </EF:EFRegion>
    </div>
</EF:EFPage>
...
<script type="text/javascript">
    ...
    function reload() {
        ...
        EiCommunicator.send("MSSP01", "queryTree",inInfo ,{
