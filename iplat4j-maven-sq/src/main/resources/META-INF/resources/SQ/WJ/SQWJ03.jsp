...
<EF:EFPage >
	<EF:EFRegion id="inqu" title="关联问卷" showClear="true">
        ...
        <EF:EFSelect ename="inqu_status-0-standardName" cname="上级问卷主题"
			resultId="standardName" filter="contains" optionLabel="请选择"
			textField="standardName" valueField="standardCode" colWidth="5" ratio="4:8"
			serviceName="SQWJ03" methodName="standardName" template="#=textField#" required="true" >
		</EF:EFSelect>
