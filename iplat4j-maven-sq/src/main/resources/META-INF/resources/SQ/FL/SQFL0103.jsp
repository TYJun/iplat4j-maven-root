...
<EF:EFPage>
	<EF:EFRegion id="inqu" title="分组名称" showClear="true">
		<div class="row" id="idName">
			<EF:EFInput ename="groupId" cname="人员组ID" colWidth="5" ratio="2:8" required="true"/>
		</div>
	...
	<EF:EFRegion id="result" title="人员列表" fitHeight="true">
		<EF:EFGrid blockId="result" autoDraw="no" serviceName="SQFL0101"
			checkMode="multiple,row" rowNo="true" isFloat="true" autoBind="true">
			...
			<EF:EFColumn ename="deptNum" cname="科室编码" enable="false" align="center" />
			<EF:EFColumn ename="deptName" cname="科室名称" enable="false" align="center" hidden="true"/>
		</EF:EFGrid>
	</EF:EFRegion>
</EF:EFPage>
