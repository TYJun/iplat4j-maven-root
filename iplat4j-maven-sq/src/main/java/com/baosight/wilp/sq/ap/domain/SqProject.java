...
* 
*/
public class SqProject extends DaoEPBase {
    ...
    private List<?> SqProjectInstance;  /* 项目标准明细*/
    private String points = " ";  /* 项目总分*/
    private String advice = " "; /* 意见和建议*/
    ...
    public void initMetaData() {
        ...
        eiColumn = new EiColumn("points");
        eiColumn.setDescName("项目总分");
        eiMetadata.addMeta(eiColumn);

        eiColumn = new EiColumn("advice");
        eiColumn.setDescName("意见和建议");
        eiMetadata.addMeta(eiColumn);
    }
    ...
    public List<?> getSqProjectInstance() {
        return SqProjectInstance;
    }

    public void setSqProjectInstance(List<?> sqProjectInstance) {
        SqProjectInstance = sqProjectInstance;
    }
    ...
    public void fromMap(Map map) {
        ...
        setPoints(StringUtils.defaultIfEmpty(StringUtils.toString(map.get("points")), points));
    }
    ...
    public Map toMap() {
        ...
        map.put("points",StringUtils.toString(points, eiMetadata.getMeta("points")));
        return map;
    }
}