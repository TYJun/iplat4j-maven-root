...
<!--需求计划信息-->
<EF:EFPage title="需求计划信息">
	<EF:EFRegion id="inqu" title="需求计划">
		<div class="row">
			<EF:EFInput ename="inqu_status-0-planNo" cname="需求计划单号" readonly="true" colWidth="5"/>
			<EF:EFInput ename="inqu_status-0-planTypeName" cname="需求计划类型" readonly="true" colWidth="5"/>
		</div>
		<div class="row">
			<EF:EFInput ename="inqu_status-0-planTime" cname="计划时间" readonly="true" colWidth="5"/>
		...
		<div class="row">
			<EF:EFInput ename="inqu_status-0-remark" cname="${type == '临时' ? '申请理由' : '备注'}" type="textarea" colWidth="5" readonly="true"/>
		</div>
	</EF:EFRegion>
