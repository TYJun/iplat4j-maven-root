...
<EF:EFPage title="月度需求计划管理">
    <EF:EFRegion id="inqu" title="查询条件" showClear="true">
        <div class="row">
            ...
            <EF:EFDatePicker ename="inqu_status-0-planTime" cname="月份" format="yyyy-MM"></EF:EFDatePicker>
    ...
    <EF:EFRegion id="result" title="月度需求计划列表">
        <EF:EFGrid blockId="result" autoDraw="no" autoBind="true" checkMode="single,row" readonly="true">
            <EF:EFColumn ename="id" cname="id" hidden="true"/>
            <EF:EFColumn ename="planNo" cname="月度需求计划单号" align="center" displayType="url"/>
            <EF:EFColumn ename="planTime" cname="月份" align="center"/>
