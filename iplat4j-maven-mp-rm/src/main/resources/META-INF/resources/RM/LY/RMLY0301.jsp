...
<EF:EFPage>
	<EF:EFRegion id="inqu" title="审批">
		<div class="row">
			...
			<EF:EFInput ename="inqu_status-0-recCreatorName" cname="领用人" readonly="true" colWidth="5"/>
			<EF:EFInput ename="inqu_status-0-recCreator" cname="领用人" type="hidden"/>
