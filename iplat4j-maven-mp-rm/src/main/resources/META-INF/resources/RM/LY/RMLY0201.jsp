			...
			<div class="col-md-5">
				<div class="form-group">
					...
					<div class="col-xs-8">
						...
						<input id="inqu_status-0-costDeptName" name="inqu_status-0-costDeptName" ondblclick="showAll('inqu_status-0-costDeptName')" >
					</div>
				</div>
			</div>
		</div>
			...
			<div class="col-md-5">
				<div class="form-group">
					...
					<div class="col-xs-8">
						...
						<input id="inqu_status-0-recCreatorName" name="inqu_status-0-recCreatorName" ondblclick="showAll('inqu_status-0-recCreatorName')" >
					</div>
				</div>
			</div>
