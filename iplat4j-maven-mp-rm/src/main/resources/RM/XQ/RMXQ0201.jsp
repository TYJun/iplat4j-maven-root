...
<!--月度需求计划信息-->
<EF:EFPage title="月度需求计划信息">
    <EF:EFRegion id="inqu" title="需求计划">
        <div class="row">
            <EF:EFDatePicker ename="inqu_status-0-planTime" cname="月份" format="yyyy-MM" required="true"
                             colWidth="5"></EF:EFDatePicker>
        ...
        <div class="row">
            <EF:EFInput ename="inqu_status-0-planDesc" cname="需求计划描述" type="textarea" colWidth="5"
    ...
    <EF:EFRegion id="result" title="月度需求计划明细列表">
