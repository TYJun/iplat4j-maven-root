...
<%
    request.setAttribute("showDept", UserSession.getOutRequest().get("showDept"));
%>
...
<EF:EFPage title="物资选择">
    ...
    <EF:EFRegion id="mat" title="物资列表">
        <EF:EFGrid blockId="mat" autoDraw="no" autoBind="true" checkMode="row" readonly="true" serviceName="RMPZ0202">
            <EF:EFColumn ename="pictureUri" cname="图片" align="center"/>
