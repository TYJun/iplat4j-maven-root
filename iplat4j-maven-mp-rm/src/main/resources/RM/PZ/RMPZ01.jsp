                        ...
                        <td>
                            <div class="td-class">
                                <c:if test="${item.hasRadio}">
                                    <EF:EFInput ename="inqu_status-${itemStatus.index}-configValueRadio" cname="是"
                                                value="Y" type="radio" inline="true"/>
                                    <EF:EFInput ename="inqu_status-${itemStatus.index}-configValueRadio" cname="否"
                                                value="N" type="radio" inline="true"/>
                                </c:if>
