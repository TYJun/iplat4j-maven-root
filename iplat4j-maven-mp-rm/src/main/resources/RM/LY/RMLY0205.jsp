        ...
        <div class="col-md-6">
            <EF:EFRegion id="add_claim" title="领用申请">
                    ...
                    <div class="col-md-6">
                        <div class="form-group">
                            ...
                            <div class="col-xs-8">
                                ...
                                <input id="add_claim-0-costDeptName" name="add_claim-0-costDeptName"
                                       ondblclick="showAll('add_claim-0-costDeptName')">
                            </div>
                        </div>
                    </div>
                </div>
                <div class="row">
                    <div class="col-md-6">
                        <div class="form-group">
                            ...
                            <div class="col-xs-8">
                                ...
                                <input id="add_claim-0-applyUserName" name="add_claim-0-applyUserName"
                                       ondblclick="showAll('add_claim-0-applyUserName')">
                            </div>
                        </div>
                    </div>
                    <EF:EFSelect ename="add_claim-0-wareHouseNo" cname="仓库" colWidth="6" optionLabel="请选择仓库"
                    ...
                    <EF:EFInput ename="add_claim-0-remark" cname="备注" type="textarea" colWidth="6"
