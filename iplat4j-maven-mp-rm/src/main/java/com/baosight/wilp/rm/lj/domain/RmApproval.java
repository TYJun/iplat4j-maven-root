...
public class RmApproval extends DaoEPBase {
    ...
    public void initMetaData() {
        ...
        eiColumn = new EiColumn("signImg");
        eiColumn.setDescName("签字图片");
        eiMetadata.addMeta(eiColumn);
    ...
    public void fromMap(Map map) {
        ...
        setSignImg(RmUtils.toString(map.get("signImg"), signImg));
    }
    ...
    public Map toMap() {
        ...
        map.put("signImg",StringUtils.toString(signImg, eiMetadata.getMeta("signImg")));
        return map;
    }
