...
public class WareHouseDataSplitUtils {
    ...
    public static List<Map<String, String>>  getUserWareHouse(String workNo) {
        ...
        EiInfo invoke = com.baosight.wilp.rm.common.RmUtils.invoke("SIWH01", "queryWareHouse", Arrays.asList("workNo"), workNo);
        ...
        for (Map warehouse : wList) {
            ...
            map.put("wareHouseNo", com.baosight.wilp.rm.common.RmUtils.toString(warehouse.get("wareHouseNo")));
            map.put("wareHouseName", com.baosight.wilp.rm.common.RmUtils.toString(warehouse.get("wareHouseName")));
            list.add(map);
        }
        return list;
    }
    ...
    public static String getWareHouseMatRootType(String workNo) {
        List<String> wareHouseNos = getWareHouseNos(workNo);
        EiInfo invoke = com.baosight.wilp.rm.common.RmUtils.invoke("SIPZ03", "queryMatRootTypes",
                Arrays.asList("wareHouseNos"), wareHouseNos);
        List<String> matRootTypes = com.baosight.wilp.rm.common.RmUtils.toList(invoke.get("matRootTypes"), String.class);
    ...
    public static String getApplyMatRootType(String claimType) {
        ...
        EiInfo invoke = com.baosight.wilp.rm.common.RmUtils.invoke("SIPZ03", "queryApplyMatRootTypes",
