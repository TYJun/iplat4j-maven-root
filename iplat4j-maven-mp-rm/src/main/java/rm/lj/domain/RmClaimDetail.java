...
public class RmClaimDetail extends DaoEPBase {
    ...
    public void initMetaData() {
        ...
        eiColumn.setDescName("状态：0=未驳回, 1=已驳回");
        eiMetadata.addMeta(eiColumn);

        eiColumn = new EiColumn("returnReason");
    ...
    public void fromMap(Map map) {
        ...
        setReturnReason(RmUtils.toString(map.get("returnReason"), returnReason));
    }
    ...
    public Map toMap() {
        ...
        map.put("returnReason",StringUtils.toString(returnReason, eiMetadata.getMeta("returnReason")));
        return map;
    }
}
