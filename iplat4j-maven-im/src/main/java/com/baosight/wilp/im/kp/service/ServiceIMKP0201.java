...
import com.baosight.wilp.im.kp.domain.IMKP0201;
 ...
 * <desc>    // 描述修改内容
 */
public class ServiceIMKP0201 extends ServiceBase{
	...
	public EiInfo initLoad(EiInfo inInfo) {
		...
		String id = inInfo.getAttr().get("id").toString();
		  ...
		  EiBlock addBlock = inInfo.addBlock("result");
		   addBlock.addBlockMeta(new IMKP0201().eiMetadata);
		  Map<String, Object> map = new HashMap<String, Object>();
		  List<Map<String, Object>> listMap = new ArrayList();
		  // 判断id是否为空
		  if (StringUtils.isNotBlank(id)) {
			  
		   List<Map<String, Object>> listBasics = dao.query("IMKP0201.getBasicsInfo", id);
		   List<Map<String, Object>> listProject = dao.query("IMKP0201.getProjectInfo", id);
	...
	public EiInfo delete(EiInfo inInfo) {
		EiInfo outInfo = super.delete(inInfo, "IMKP0201.delete");
		return outInfo;
	}
	...
	public EiInfo updateResult(EiInfo inInfo){
        ...
        //修改卡片信息
		int update = dao.update("IMKP0201.updateInfo", hashMap);
		if(update>0) {
		    //调用卡片项目信息方法
	...
	public void updateProjectInfo(String cardID,EiInfo inInfo){
		dao.delete("IMKP0201.deleteProjectInfo", cardID);
		...
		for(int i = 0; i < list.size(); i++) {
			...
			dao.insert("IMKP0201.saveProjectInfo", hashMap);
		}
	}
     ...
     */
	 private String generateCode() {
	  synchronized (dao) {
	   ...
	   List<String> list = dao.query("IMKP02.queryContTypeNum", "CR" + date);
