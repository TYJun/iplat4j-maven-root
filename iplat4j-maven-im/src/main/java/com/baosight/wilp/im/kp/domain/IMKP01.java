...
*/
package com.baosight.wilp.im.kp.domain;
...
* 
*/
public class IMKP01 extends DaoEPBase {
    ...
    private String memo = " ";		 /* 卡片备注*/
    private Timestamp createtime ;		/* 创建时间*/
    private String createman = " ";		/* 创建人*/
    private String createip = " ";		/* 创建类型*/
    private Timestamp modifytime ;		/* 修改时间*/
    private String modifyman = " ";		/* 修改人*/
    private String modifyip = " ";		/* 修改类型*/
