...
<%--			</EF:EFSelect>--%>
	...
	<EF:EFTab id="FaDaTab">
		<div title="资产台账">
			<EF:EFGrid blockId="resultB" autoDraw="no" rowNo="true" autoBind="true" readonly="true" checkMode="multiple,row" queryMethod="confirmedQuery" height="418px" sort="setted">
				...
				<EF:EFColumn ename="useYears" cname="使用年限"   align="center" width="200" sort="true"/>
		...
		<div title="开卡操作">
			<EF:EFGrid blockId="resultC" autoDraw="no" rowNo="true" autoBind="true" readonly="true" checkMode="multiple,row" queryMethod="confirmedQueryC" height="418px" sort="setted">
				<EF:EFColumn ename="id" cname="id"  align="center" hidden="true"/>
				<EF:EFColumn ename="faInfoId" cname="faInfoId"  align="center" hidden="true"/>
				<EF:EFColumn ename="goodsNum" cname="资产编号"  align="center" displayType="url" enable="false" sort="true"/>
				<EF:EFColumn ename="goodsName" cname="设备名称" align="center" sort="true"/>
				<EF:EFColumn ename="model" cname="型号"  align="center" hidden="true"/>
				<EF:EFColumn ename="spec" cname="型号规格"  align="center" sort="true"/>
				<EF:EFColumn ename="deptName" cname="所属科室"   align="center" sort="true"/>
				<EF:EFColumn ename="buyCost" cname="资产原值"   align="center" sort="true"/>
				<EF:EFColumn ename="netAssetValue" cname="资产净值"  align="center" sort="true"/>
