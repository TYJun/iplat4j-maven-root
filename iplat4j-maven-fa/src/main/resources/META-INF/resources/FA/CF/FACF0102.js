    ...
    "resultSplitByValue": {
        ...
        afterEdit: function (e) {
            ...
            if (e.field == "buyCost") {
                ...
                var nowTotalDepreciation = ((nowBuyCost / buyCost).toFixed(2) * totalDepreciation).toFixed(2)
                var nowNetAssetValue = ((nowBuyCost / buyCost).toFixed(2) * netAssetValue).toFixed(2)
