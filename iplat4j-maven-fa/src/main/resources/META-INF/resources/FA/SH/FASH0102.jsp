...
<title>资产上会单</title>
<EF:EFPage title="资产上会单详情">
    <EF:EFRegion id="info" head="hidden">
        <div class="row">
            <EF:EFInput ename="info-0-discussId" cname="会议id" colWidth="3" required="true" type="hidden"/>
            <EF:EFInput ename="info-0-type" cname="type" colWidth="3" required="true" type="hidden"/>
            <EF:EFInput ename="info-0-discussName" cname="会议名称" colWidth="3" required="true" readonly="true"/>
            <EF:EFDatePicker ename="info-0-discussDate" cname="会议时间" role="date"
                             readonly="true" colWidth="3" ratio="4:8" format="yyyy-MM-dd" disabled="true"/>
        </div>
        <div class="button-region" id="buttonDiv">
            <div id="wasting">
                <EF:EFButton cname="上会通过" ename="wastingSUBMIT" layout="3"></EF:EFButton>
            </div>
<%--            <EF:EFButton cname="取消" ename="CANCEL" layout="3"></EF:EFButton>--%>
            <div id="wasted" style="display: none">
                <EF:EFButton cname="上会单销账" ename="wastedSUBMIT" layout="3"></EF:EFButton>
            </div>
        </div>
    </EF:EFRegion>
    <EF:EFRegion id="result" title="上会资产列表">
        <EF:EFGrid blockId="result" autoDraw="no" autoBind="true" rowNo="true" readonly="true"
                   checkMode="multiple,row" height="560px" filterable="true" queryMethod="initLoad">
            <EF:EFColumn ename="faInfoId" cname="faInfoId" align="center" width="200" hidden="true"/>
            <EF:EFColumn ename="discussId" cname="discussId" align="center" width="200" hidden="true"/>
            ...
            <EF:EFColumn ename="recCreateName" cname="创建人" align="center" width="200" enable="false" hidden="true"/>
    ...
    <!-- 固资资产选择弹出窗 -->
    <EF:EFWindow id="popData" url="" lazyload="true" width="100%" height="100%" title="增加上会资产" modal="true"/>
</EF:EFPage>