...
<EF:EFPage>
	<EF:EFRegion id="inqu" title="采购入库信息">
		<div class="row">
			...
			<EF:EFInput ename="inqu_status-0-enterType" cname="入库类型" value="06" type="hidden"/>
		</div>
	</EF:EFRegion>
	<EF:EFRegion id="result" title="采购入库物资信息">
		<EF:EFGrid blockId="result" autoDraw="no" autoBind="true" checkMode="row" >
			<EF:EFColumn ename="orderId" cname="订单Id" hidden="true"/>
			...
			<EF:EFColumn ename="warrantyDate" cname="质保截止日" editType="date" dateFormat="yyyy-MM-dd" defaultValue="" width="100" align="center" />
		</EF:EFGrid>
	</EF:EFRegion>
</EF:EFPage>
