 ...
 * @author fangjian
 * @version V5.0.0
 * @Description: 物资采购人员角色、权限查询
 * @ClassName: ServiceMPTY02
 * @Package com.baosight.wilp.rm.ty.service
 * @date: 2023年02月03日 14:05
 */
public class ServiceMPTY02 extends ServiceBase {
    ...
    public EiInfo getParentGroupsByLoginName(EiInfo inInfo) {
        ...
        if (loginName != null && groupType != null) {
            try {
                ...
                parentList = dao.query("MPTY02.queryParentGroupsByLoginName", map);
