...
public class SerialNoUtils {
    ...
    public static String generateSerialNo(String name, String prefix, String dateFormat, int suffixLength) {
        ...
        try {
            /**1.查询cu_model_number表中的序号**/
            EiInfo invoke = MpUtils.invoke("MPCG0101", "querySerialNo", Arrays.asList("type"), name);
            ...
            /**3.更新单号**/
            MpUtils.invoke("MPCG0101", "updateSerialNo", Arrays.asList("serialNo", "op", "type"), serialNo, op, name);
        } finally {
            lock.unlock();
        }
        return serialNo;
