 ...
 * @author fangjian
 */
public class MpConfig extends DaoEPBase {
    ...
    public void fromMap(Map map) {
        ...
        setConfigCode(MpUtils.toString(map.get("configCode"), configCode));
        setConfigName(MpUtils.toString(map.get("configName"), configName));
        setConfigValueRadio(MpUtils.toString(map.get("configValueRadio"), configValueRadio));
        setConfigValueText(MpUtils.toString(map.get("configValueText"), configValueText));
