package com.baosight.wilp.pm.sj.service;
 ...
 * <p>4.提交 audiaArchive
 * 
 * @Title: ServicePM06.java
 * @ClassName: ServicePM06
 * @Package：com.baosight.wilp.pm.service
 * @author: zhaow
 * @date: 2021年8月28日 下午4:50:14
 * @version: V1.0
 ...
 * <desc>    // 描述修改内容
 */
public class ServicePM06 extends ServiceBase {
	...
	public EiInfo initLoad(EiInfo inInfo) {
        ...
        inquStatus.setCell(0, "docStatusCode", "02");
        //resultA
	...
	public EiInfo queryCalculate(EiInfo inInfo) {
		...
		//查询数据
		List<TpmVia> list = dao.query("PM05.queryCalculateList",map, (Integer)map.get("offset"), (Integer)map.get("limit"));
		//获取总数
	 ...
	 * @throws
	 */
	public EiInfo audiaArchive(EiInfo inInfo) {
		//参数处理
