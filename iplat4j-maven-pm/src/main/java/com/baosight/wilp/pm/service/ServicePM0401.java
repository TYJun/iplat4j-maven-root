...
public class ServicePM0401 extends ServiceBase {
	...
	public EiInfo queryStage(EiInfo inInfo) {
		// 调用封装方法
		return queryTabGrid(inInfo, "PM0103.queryStageList", "PM0103.queryStageCount", "resultH", new TpmStage().eiMetadata);
	}
	...
	public EiInfo queryDeleteFile(EiInfo inInfo) {
		// 调用封装方法
		return queryTabGrid(inInfo, "PM0103.queryDeleteFile", "PM0103.queryDeleteFileCount", "resultI", new TpmAtt().eiMetadata);
	}
	...
	public EiInfo saveProject(EiInfo inInfo) {
		...
		saveFile(fileObj,PM01.getId(),staffByUserId,deleteFile);
		...
		if (true) {
			...
			//设置参数
			eiInfo.set("configType", "projectFinish");
	...
	//保存项目附件信息
	@SuppressWarnings("unchecked")
	private void saveFile(Object fileObj, String id,Map<String, Object> staffByUserId,List<Map<String, Object>> deleteFile) {
