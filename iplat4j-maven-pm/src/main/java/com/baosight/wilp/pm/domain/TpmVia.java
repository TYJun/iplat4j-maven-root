...
public class TpmVia extends DaoEPBase {

    private static final long serialVersionUID = 1L;

    private String id = " ";		/* 项目督办主键*/
    private String projectPk = " ";		/* 项目主键*/
    private String superviseMaker = " ";		/* 督办人*/
    private String superviseMakerName = " ";		/* 督办人姓名*/
    private String superviseInfo = " ";		/* 督办信息*/
    ...
    public void initMetaData() {
        ...
        eiColumn = new EiColumn("superviseMaker");
        eiColumn.setDescName("督办人");
        eiMetadata.addMeta(eiColumn);
        
        eiColumn = new EiColumn("superviseMakerName");
        eiColumn.setDescName("督办人");
        eiMetadata.addMeta(eiColumn);

        eiColumn = new EiColumn("execMaker");
        eiColumn.setDescName("执行人");
        eiMetadata.addMeta(eiColumn);

        eiColumn = new EiColumn("superviseInfo");
        eiColumn.setDescName("督办信息");
        eiMetadata.addMeta(eiColumn);
    ...
    /**
     * get the superviseMaker - 督办人
     * @return the superviseMaker
     */
    public String getSuperviseMaker() {
        return this.superviseMaker;
    }

    /**
     * set the superviseMaker - 督办人
     */
    public void setSuperviseMaker(String superviseMaker) {
        this.superviseMaker = superviseMaker;
    }

    /**
     * get the superviseInfo - 督办信息
     * @return the superviseInfo
     */
    ...
    public String getSuperviseMakerName() {
		return superviseMakerName;
	}

	public void setSuperviseMakerName(String superviseMakerName) {
		this.superviseMakerName = superviseMakerName;
	}
    ...
    public void fromMap(Map map) {
        ...
        setSuperviseMaker(StringUtils.defaultIfEmpty(StringUtils.toString(map.get("superviseMaker")), superviseMaker));
        setSuperviseMakerName(StringUtils.defaultIfEmpty(StringUtils.toString(map.get("superviseMakerName")), superviseMakerName));
        setSuperviseInfo(StringUtils.defaultIfEmpty(StringUtils.toString(map.get("superviseInfo")), superviseInfo));
    ...
    public Map toMap() {
        ...
        map.put("superviseMaker",StringUtils.toString(superviseMaker, eiMetadata.getMeta("superviseMaker")));
        map.put("superviseMakerName",StringUtils.toString(superviseMakerName, eiMetadata.getMeta("superviseMakerName")));
        map.put("superviseInfo",StringUtils.toString(superviseInfo, eiMetadata.getMeta("superviseInfo")));
