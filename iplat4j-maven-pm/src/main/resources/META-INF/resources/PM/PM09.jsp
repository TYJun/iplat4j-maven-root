		...
		<div class="A">
			<table class="table1">
				...
				<tr>
					...
					<td>
						<input type="text" value="系统中登记了项目名称为$project_name$的工程项目，项目号：$project_no$，请到系统的工程项目中查看并及时处理！"
				...
				<tr>
					...
					<td>
						<input type="text" value="项目名为$project_name$，项目号：$project_no$的项目督办人变更为$project_via$。"
