...
<EF:EFPage>
	<EF:EFRegion id="result" title="归档结算" showClear="true">
		<div class="row">
			...
			<EF:EFPopupInput ename="inqu_status-0-dataSubmitterCode" cname="资料提交人员" readOnly="true" 
				popupTitle="人员选择" required="true" popupWidth="400"
				popupType="ServiceGrid" serviceName="PM0103" methodName="queryPerson" resultId="person"
				valueField="workNo" textField="name"
				columnEnames="workNo,name,deptName" columnCnames="工号,姓名,科室名称" />
			<EF:EFPopupInput ename="inqu_status-0-dataRecipientCode" cname="审计接受人员" readOnly="true" 
				popupTitle="人员选择" required="true" popupWidth="400"
				popupType="ServiceGrid" serviceName="PM0103" methodName="queryPerson" resultId="person"
				valueField="workNo" textField="name"
				columnEnames="workNo,name,deptName" columnCnames="工号,姓名,科室名称" />
			<EF:EFPopupInput ename="inqu_status-0-dataCode" cname="提交资料" readOnly="true"
			...
			<EF:EFInput ename="inqu_status-0-calCharge" cname="审计确认金额" required="true" />
			<EF:EFPopupInput ename="inqu_status-0-dataSubmitterCodeBack" cname="报告交付人员"  
				popupTitle="人员选择" required="true" popupWidth="400"
				popupType="ServiceGrid" serviceName="PM0103" methodName="queryPerson" resultId="person"
				valueField="workNo" textField="name"
				columnEnames="workNo,name,deptName" columnCnames="工号,姓名,科室名称" />
			<EF:EFPopupInput ename="inqu_status-0-dataRecipientCodeBack" cname="报告接收人员"  
				popupTitle="人员选择" required="true" popupWidth="400"
				popupType="ServiceGrid" serviceName="PM0103" methodName="queryPerson" resultId="person"
				valueField="workNo" textField="name"
				columnEnames="workNo,name,deptName" columnCnames="工号,姓名,科室名称" />
...
<script type="text/javascript">
	$(function() {
		...
		$("#SAVE").on("click", function() {
			...
			//校验
			if(isEmpty(eiInfo.get("inqu_status-0-dataSubmitterCodeBack_textField"))){
				IPLAT.NotificationUtil("请选择报告交付人员");
				return false;
			}
			if(isEmpty(eiInfo.get("inqu_status-0-dataRecipientCodeBack_textField"))){
				IPLAT.NotificationUtil("请选择报告接受人员");
				return false;
			}
			//审计确认金额
			var regst= /^\d*\.?\d+$/;
			if(!regst.test(eiInfo.get("inqu_status-0-calCharge"))){
				IPLAT.NotificationUtil("请重新输入审计确认金额为正数");
				return false;
			}
			//提交
			EiCommunicator.send("PM0701", "editArchive", eiInfo, {
