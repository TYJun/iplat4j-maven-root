...
<EF:EFPage>
	...
	<EF:EFRegion id="result" title="人员配置信息">
		<EF:EFGrid blockId="result" autoDraw="no" checkMode="single,row" autoBind="false" readonly="true" rowNo="true">
			...
			<EF:EFColumn ename="outTime" cname="离职时间" width="150" align="center" enable="false"/>
...
<EF:EFWindow id="popData" title="新增信息" url=" " lazyload="true" width="80%" height="80%"></EF:EFWindow>
<EF:EFWindow id="popDataModify" title="离职确认" url=" " lazyload="true" width="30%" height="45%"></EF:EFWindow>