...
<EF:EFPage>
	<EF:EFRegion id="inqu" title="详情">
		<div class="row">
			...
			<EF:EFInput ename="numbers" cname="支援人数" colWidth="3" required="true" ratio="3:8"  readonly="true"/>
			...
			<EF:EFInput ename="supportStation" cname="支援岗位" colWidth="3" required="true" ratio="3:8"  readonly="true"/>
