...
public class SerialNoUtils {
    ...
    public static String generateSerialNo(String name, String prefix, String dateFormat, int suffixLength) {
        ...
        try {
            /**1.查询cu_model_number表中的序号**/
            EiInfo invoke = HrUtils.invoke(null, "HRTY01", "querySerialNo", new String[]{"type"}, name);
            ...
            /**3.更新单号**/
            HrUtils.invoke(null,"HRTY01", "updateSerialNo", new String[]{"serialNo", "op", "type"}, serialNo, op, name);
        } finally {
            lock.unlock();
        }
        return serialNo;
