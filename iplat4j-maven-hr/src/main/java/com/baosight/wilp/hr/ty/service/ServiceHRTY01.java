package com.baosight.wilp.hr.ty.service;
 ...
 * 2.保存序列号
 */
public class ServiceHRTY01 extends ServiceBase {
    ...
    public EiInfo querySerialNo (EiInfo inInfo) {
        List<String> list = dao.query("HRTY01.querySerialNo", inInfo.getString("type"));
    ...
    **/
    ...
    public EiInfo updateSerialNo(EiInfo inInfo) {
        ...
        if("add".equals(op)){
            ...
            dao.insert("HRTY01.insertSerialNo", map);
        } else {
            map.put("updateTime", DateUtils.curDateTimeStr19());
            dao.update("HRTY01.updateSerialNo", map);
        }
        return inInfo;
    }
