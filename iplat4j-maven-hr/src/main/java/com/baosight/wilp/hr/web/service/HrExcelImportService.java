package com.baosight.wilp.hr.web.service;
 ...
 */
public interface HrExcelImportService {

    List<HrExcelHeader> cacheHeaders = new ArrayList<>();
     ...
     * @throws
     **/
    List<HrExcelHeader> buildHeader();
     ...
     * @throws
     **/
    default List<HrExcelHeader> getHeaders() {
     ...
     * @throws
     **/
    default Workbook buildTemplate(List<HrExcelHeader> headerList, List<String[]> dataList) {
        return HrExcelUtils.createWorkBook(headerList, dataList);
    }
    ...
    default List<String[]> parseExcel(InputStream inputStream) throws Exception {
        return HrExcelUtils.parseExcel(inputStream, this);
    }
