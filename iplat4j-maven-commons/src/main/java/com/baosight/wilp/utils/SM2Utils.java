...
public class SM2Utils {
     ...
     * @Description 私钥解密
     * @Author msx
     * @param privateKey SM2十六进制私钥
     * @param cipherData    密文数据
     * @return String
     */
    public static String decrypt(String privateKey, String cipherData) {
        return decrypt(privateKey, cipherData, 1);
    }
...
//                ecParameterSpec.getG(), ecParameterSpec.getN());
        ...
        ECPrivateKeyParameters ecPrivateKeyParameters = new ECPrivateKeyParameters(privateKeyD,
                domainParameters);
        //通过解密模式创建解密引擎并初始化
        SM2Engine sm2Engine = new SM2Engine(mode);
...
//        String publicKeyHex = "04B80C7502515C1EF3BBAADC81BCE2F5CCFE417B248C4E7A347D3B10285D013B44EF9465F7470F3C9EC10DA9679313DD50101011C245AADD7426BAAD7632CA51B2";
...
////        String data = "车牌xxxxxxxxxxxxxxxxxxxxxxxxx1111111111111111111111111111111";
//        String data = null;
//
...
//        data = decrypt(privateKey, encryptData);
