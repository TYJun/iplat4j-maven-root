/**
* Generate time : 2021-05-04 10:58:26
...
* 
*/
public class PRGL05 extends DaoEPBase {
    ...
    private String localtypecode = " ";		/* 问题类型*/
    ...
    public void fromMap(Map map) {
        ...
        setDesc1(StringUtils.defaultIfEmpty(StringUtils.toString(map.get("desc1")), desc1));
    ...
    public Map toMap() {
        ...
        map.put("desc1",StringUtils.toString(desc1, eiMetadata.getMeta("desc1")));
