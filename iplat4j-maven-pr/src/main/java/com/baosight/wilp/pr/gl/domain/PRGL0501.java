...
* 
*/
public class PRGL0501 extends DaoEPBase {

    private static final long serialVersionUID = 1L;

    private String dangerresultid = " ";		/* 主键*/
    ...
    public void fromMap(Map map) {
        ...
        setDangerresultid(StringUtils.defaultIfEmpty(StringUtils.toString(map.get("dangerresultid")), dangerresultid));
