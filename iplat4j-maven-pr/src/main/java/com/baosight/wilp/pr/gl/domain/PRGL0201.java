/**
* Generate time : 2021-04-30 16:34:51
 ...
 * <desc>    // 描述修改内容
 */
public class PRGL0201 extends DaoEPBase {

    private static final long serialVersionUID = 1L;

    private String dangerid = "";		/*  主键*/
    ...
    private String localtypecode = " ";		/* 问题类型编码*/
    private String localTypeName = " ";		/* 问题类型*/
    ...
    public void initMetaData() {
        ...
        eiColumn.setDescName("整改完成时间");
        eiMetadata.addMeta(eiColumn);
        
        eiColumn = new EiColumn("writeMan");
        eiColumn.setDescName("整改登记人");
        eiMetadata.addMeta(eiColumn);
        
        eiColumn = new EiColumn("writeTime");
        eiColumn.setDescName("整改登记时间");
        eiMetadata.addMeta(eiColumn);
        ...
        eiColumn.setDescName("问题编码");
        eiMetadata.addMeta(eiColumn);

        eiColumn = new EiColumn("localTypeName");
    ...
    public void fromMap(Map map) {
        ...
        setLocalTypeName(StringUtils.defaultIfEmpty(StringUtils.toString(map.get("localTypeName")), localTypeName));
    ...
    public Map toMap() {
        ...
        map.put("localTypeName",StringUtils.toString(localTypeName, eiMetadata.getMeta("localTypeName")));
