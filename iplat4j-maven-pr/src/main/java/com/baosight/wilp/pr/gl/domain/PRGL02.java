/**
* Generate time : 2021-03-01 16:20:49
 ...
 * <desc>    // 描述修改内容
 */
public class PRGL02 extends DaoEPBase {
    ...
    private String acceptType = " ";		/* 0--正常认领; 3--核查; 2--派发*/
    private String msgstatus = "0";		/* 发送成功状态标记:0: 未发送消息 1-待认领超过12小时; 2-待认领超过24小时; 3-已认领未整改超过12小时; 4-已认领未整改超过24小时*/
    ...
    public void initMetaData() {
        ...
        eiColumn.setDescName("0--正常认领; 3--核查; 2--派发");
        eiMetadata.addMeta(eiColumn);
        ...
        eiColumn.setDescName("发送成功状态标记:0: 未发送消息 1-待认领超过12小时; 2-待认领超过24小时; 3-已认领未整改超过12小时; 4-已认领未整改超过24小时");
        eiMetadata.addMeta(eiColumn);
    ...
    /**
     * get the acceptType - 0--正常认领; 3--核查; 2--派发
    ...
    /**
     * set the acceptType - 0--正常认领; 3--核查; 2--派发
     */
    ...
    /**
     * get the msgstatus - 发送成功状态标记:0: 未发送消息 1-待认领超过12小时; 2-待认领超过24小时; 3-已认领未整改超过12小时; 4-已认领未整改超过24小时
    ...
    /**
     * set the msgstatus - 发送成功状态标记:0: 未发送消息 1-待认领超过12小时; 2-待认领超过24小时; 3-已认领未整改超过12小时; 4-已认领未整改超过24小时
     */
