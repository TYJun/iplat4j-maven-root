...
<%--                <EF:EFColumn ename="openId" cname="住院号" width="100" align="center" readonly="true"/>--%>
                ...
                <EF:EFColumn ename="recCreateTime" cname="退单时间" width="100" align="center" readonly="true" hidden="true" />
       ...
       <div title="已处理">
         <EF:EFRegion id="result2" title="记录集">
            <EF:EFGrid blockId="result2" serviceName="PSBMDDZF01" queryMethod="query2" autoDraw="no" rowNo="true" readonly="true" >
                <!-- 隐藏列 -->
                <EF:EFColumn ename="id" cname="id" width="100" hidden="true" />
                <EF:EFColumn ename="isDelete" cname="isdelete" width="100" hidden="true" />
                <EF:EFColumn ename="payType" cname="付款方式" width="100" align="center" readonly="true" hidden="true" />
...
function formatOrderCz(row){
    ...
    if(code=="1"){
        return "<a style='color:red;' href=\"#\" onclick=\"operationPatientOrder('"+id+"','PSBMDDZF01?confirmCancelOrder','确认作废');\">确认作废</a>";
    }
}
//订单操作事件
