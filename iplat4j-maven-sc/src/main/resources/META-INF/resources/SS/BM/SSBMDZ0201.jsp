...
<EF:EFPage>
	<EF:EFRegion id="result" title="信息" fitHeight="true">
		<EF:EFSelect ename="building" cname="楼"
					 resultId="building" textField="building" valueField="building"
					 serviceName="SSBMDZ02" methodName="queryBuilding" optionLabel="请选择"
					 colWidth="4" filter="contains">
		</EF:EFSelect>
		<EF:EFSelect ename="floor" cname="层"
					 resultId="floor" textField="floor" valueField="floor"
					 serviceName="SSBMDZ02" methodName="queryFloor" optionLabel="请选择"
					 colWidth="4" filter="contains">
		</EF:EFSelect>
		<EF:EFSelect ename="deptName" cname="地址"
					 resultId="deptName" textField="deptName" valueField="deptName"
					 serviceName="SSBMDZ02" methodName="queryDeptName" optionLabel="请选择"
					 colWidth="4" filter="contains">
		</EF:EFSelect>
	</EF:EFRegion>
</EF:EFPage>
	...
	$(function() {
		$("#SUMBMIT").click(function() {
			...
			if (building == null || building == "") {
				...
				IPLAT.submitNode(node, 'SSBMDZ0201', 'insert',{
