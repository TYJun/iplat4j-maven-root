...
<%--             <EF:EFSelect ename="inqu_status-0-spotName" cname="所属楼栋" 
            ...
            <EF:EFInput ename="inqu_status-0-reqSendTime" colWidth="3" ratio="3:8" cname="取餐时间" />
	...
	<EF:EFRegion id="result" title="记录集">
		<EF:EFGrid blockId="result" autoDraw="no" rowNo="true" readonly="false">
            ...
            <EF:EFColumn ename="address" cname="取餐地点" width="100" align="center" readonly="true" hidden="true" />
...
<%--            <EF:EFColumn ename="reqSendTime" cname="取餐时间" width="100" align="center" readonly="true"/>--%>
