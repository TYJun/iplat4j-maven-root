...
<EF:EFPage prefix="MEAL">
    ...
    <EF:EFRegion id="inqu" title="查询条件" showClear="true">
        ...
        <div class="row"> 
			...
			<EF:EFSelect ename="inqu_status-0-archiveFlag" cname="点餐人员分类"
						 colWidth="3" ratio="3:8">
				<EF:EFOption label="请选择" value="" />
				<EF:EFOption label="APP点餐（学生）" value="STUAPP" />
				<EF:EFOption label="企业微信点餐（职工）" value="APP" />
			</EF:EFSelect>
<%--             <EF:EFSelect ename="inqu_status-0-spotName" cname="所属楼栋" 
            ...
            <EF:EFInput ename="inqu_status-0-selfCode" colWidth="3" ratio="3:8" cname="取餐码" />
            <EF:EFInput ename="inqu_status-0-userCode" colWidth="3" ratio="3:8" cname="职工工号" />
			<EF:EFInput ename="inqu_status-0-userName" colWidth="3" ratio="3:8" cname="姓名" />
	   ...
	   <div title="待处理">
		<EF:EFRegion id="result" title="记录集">
			<EF:EFGrid blockId="result" autoDraw="no" rowNo="true" readonly="true" checkMode="multiple, cell">
	            ...
	            <EF:EFColumn ename="address" cname="取餐地点" width="100" align="center" readonly="true" />
	            <EF:EFColumn ename="recCreateTime" cname="下单时间" width="150" align="center" readonly="true"/>
				<EF:EFColumn ename="needDate" cname="取餐时间" width="100" align="center" readonly="true"/>
<%--	            <EF:EFColumn ename="reqSendTime" cname="取餐时间" width="80" align="center" readonly="true"/>--%>
	            <EF:EFColumn ename="mealName" cname="餐次" width="100" align="center" readonly="true"/>
				<EF:EFColumn ename="canteenName" cname="食堂名称" width="80" align="center" readonly="true"/>
	   ...
	   <div title="已处理">
	     <EF:EFRegion id="result2" title="记录集">
			<EF:EFGrid blockId="result2" serviceName="SSDCZQGL01" queryMethod="query2" autoDraw="no" rowNo="true" readonly="true" >
	            <!-- 隐藏列 -->
	            <EF:EFColumn ename="id" cname="id" width="100" hidden="true" />
	            <EF:EFColumn ename="isDelete" cname="isdelete" width="100" hidden="true" />
	            <EF:EFColumn ename="payType" cname="付款方式" width="100" align="center" hidden="true" />
...
<%--                <EF:EFColumn ename="reqSendTime" cname="取餐时间" width="80" align="center" readonly="true"/>--%>
	...
	<EF:EFWindow id="shEdit" width="590px" height="629px" modal="true" url="" title="查看" style="display:none;">
		<EF:EFRegion id="edit" title="订单明细" showClear="true" >
			...
			<div class="row" >
				<EF:EFInput ename="address" cname="订餐地点" ratio="2:10" colWidth="12" readonly="true" required="true" maxLength="200" />
			</div>
			<div class="row" >
...
function rowDbClick(e){
	...
	IPLAT.EFInput.value($("#address"),e.model["address"]);
...
function formatOrderCz(row){
    ...
    if(code=="02"){
        return "<a style='color:blue;' href=\"#\" onclick=\"operationPatientOrder('"+id+"','SSDCZQGL01?confirmSend','送餐');\">开始送餐</a>";
    }
}
//订单操作事件
...
$(function() {
	...
	$("#PRINT").on("click", function(e) {
		...
		var rows2 = result2Grid.getCheckedRows();
		...
		let defaultUrl = defaultDishesList[0].label;
		let bill = [];
		for(i=0;i<=rows.length-1;i++){
			bill.push(rows[i].billNo);
		}
		var b =bill.join("','");
		console.log(b);
		let url = defaultUrl+'&'+'billNo='+b;
		window.open(url);
	});
	//取消
