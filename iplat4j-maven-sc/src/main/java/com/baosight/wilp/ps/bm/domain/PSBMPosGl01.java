...
* sc_patient_card
*/
public class PSBMPosGl01 extends DaoEPBase {
    ...
    public void fromMap(Map map) {
        ...
        setIsDelete(StringUtils.defaultIfEmpty(StringUtils.toString(map.get("isDelete")), isDelete));
    }
    ...
    public Map toMap() {
        ...
        map.put("isDelete",StringUtils.toString(isDelete, eiMetadata.getMeta("isDelete")));
        return map;
    }
}