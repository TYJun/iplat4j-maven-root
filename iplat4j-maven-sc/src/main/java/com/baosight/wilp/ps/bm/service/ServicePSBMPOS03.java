...
/**
 * 
 * ServicePSBMPOS03 病员POS订单综合查询service
 * 
 * @Title: ServicePSBMPOS03.java
 * @ClassName: ServicePSBMPOS03
 * @Package：com.baosight.wilp.ps.bm.service
 * @author: liutao
 * @date: 2021年9月9日 上午10:25:26
 * @version: V1.0
 ...
 * <desc>    // 描述修改内容
 */
public class ServicePSBMPOS03 extends ServiceBase{
	...
	public EiInfo query(EiInfo inInfo) {
		EiInfo outInfo = super.query(inInfo, "PSBMPosCx01.query", new PSBMDdcx01());
		return outInfo;
	}
}
