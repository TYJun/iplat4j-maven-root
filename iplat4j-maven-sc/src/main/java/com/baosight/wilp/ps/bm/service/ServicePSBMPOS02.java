...
import com.baosight.wilp.ps.bm.domain.PSBMPosZf01;

/**
 * 
 * ServicePSBMPOS02 病员POS订单作废service
 * 
 * @Title: ServicePSBMPOS02.java
 * @ClassName: ServicePSBMPOS02
 * @Package：com.baosight.wilp.ps.bm.service
 * @author: liutao
 * @date: 2021年9月9日 上午10:24:18
 * @version: V1.0
 ...
 * <desc>    // 描述修改内容
 */
public class ServicePSBMPOS02 extends ServiceBase{
	...
	public EiInfo initLoad(EiInfo inInfo) {
		EiInfo initLoad = super.initLoad(inInfo, new PSBMPosZf01());
	...
	public EiInfo query(EiInfo inInfo) {
		EiInfo outInfo = super.query(inInfo, "PSBMPosZf01.query", new PSBMPosGl01());
		return outInfo;
	}
	 ...
	 * @return: EiInfo 
	 * @author: liutao
	 * @date: 2021年9月9日 上午10:25:11
	 */
	public EiInfo query2(EiInfo inInfo) {
		EiInfo outInfo = super.query(inInfo, "PSBMPosZf01.query2", new PSBMPosGl01(),false, null, EiConstant.queryBlock, "result2", "result2");
		return outInfo;
	}
}
