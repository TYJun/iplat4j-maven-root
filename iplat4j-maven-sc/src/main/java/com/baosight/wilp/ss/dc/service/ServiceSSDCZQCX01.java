 ...
 * 
 * @Title: ServiceSSDCZQCX01.java
 * @ClassName: ServiceSSDCZQCX01
 * @Package：com.baosight.wilp.ss.dc.service
 * @author: liutao
 * @date: 2021年9月9日 下午3:36:54
 * @version: V1.0
 ...
 * <desc>    // 描述修改内容
 */
public class ServiceSSDCZQCX01 extends ServiceBase{
	...
	public EiInfo query(EiInfo inInfo) {
		EiInfo outInfo = super.query(inInfo, "SSDCZQCX01.query", new SSDCZQCX01());
		return outInfo;
	}
