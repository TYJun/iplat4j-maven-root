/**
* Generate time : 2021-05-25 19:27:11
...
* sc_type
*/
public class SSBMSjzd02 extends DaoEPBase {
    ...
    public void fromMap(Map map) {
        ...
        setTypegroupid(StringUtils.defaultIfEmpty(StringUtils.toString(map.get("typegroupname")), typegroupname));
        setTypegroupid(StringUtils.defaultIfEmpty(StringUtils.toString(map.get("typegroupcode")), typegroupcode));
        setTypegroupid(StringUtils.defaultIfEmpty(StringUtils.toString(map.get("moduleId")), moduleId));
