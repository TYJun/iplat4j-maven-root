/**
* Generate time : 2021-07-09 14:47:10
...
/**
* SSACTselfOrderBill 订单主表
* 
*/
public class SSACTscWorkOrderBill extends DaoEPBase {
    ...
    private BigDecimal shipFee = new BigDecimal("0");		/* 配送费*/
    ...
    private String bedNo;		/* 房间号*/
    private SSACTscWorkOrderBillDetail[] billDetail ;		/* 订单明细*/
    //折扣比例
	...
	public SSACTscWorkOrderBillDetail[] getBillDetail() {
		return billDetail;
	}

	public void setBillDetail(SSACTscWorkOrderBillDetail[] billDetail) {
    ...
    public void fromMap(Map map) {
        ...
        setShipFee(NumberUtils.toBigDecimal(StringUtils.toString(map.get("shipFee")), shipFee));
    ...
    public Map toMap() {
        ...
        map.put("reviseTime",StringUtils.toString(recReviseTime, eiMetadata.getMeta("recReviseTime")));
        map.put("recRevisor",StringUtils.toString(recRevisor, eiMetadata.getMeta("recRevisor")));
        map.put("recCreateTime",StringUtils.toString(recCreateTime, eiMetadata.getMeta("recCreateTime")));
        map.put("archiveFlag",StringUtils.toString(archiveFlag, eiMetadata.getMeta("archiveFlag")));
        map.put("billNo",StringUtils.toString(billNo, eiMetadata.getMeta("billNo")));
        map.put("billId",StringUtils.toString(id, eiMetadata.getMeta("id")));
    ...
    public String toString() {
        return "SSACTscWorkOrderBill{" +
                ...
                ", room='" + room + '\'' +
                ", bedNo='" + bedNo + '\'' +
                ", billDetail=" + Arrays.toString(billDetail) +
