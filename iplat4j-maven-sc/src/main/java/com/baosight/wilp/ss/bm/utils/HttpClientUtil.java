...
public class HttpClientUtil implements Serializable {
	 ...
	 */
	public static RespResult doPost(String url, Map<String, String> headers, Map<String, String> param,
			int timeout) {
		RespResult result = new RespResult("201", "操作失败！");
		...
		try {
			...
			result = new RespResult(jsonResult.getString("respCode"), jsonResult.getString("respMsg"));
		} catch (Exception e) {
			e.printStackTrace();
	 ...
	 * @param timeout : 连接超时时间
	 */
	public static RespResult doPost(String url, Map<String, String> param, int timeout) {
	 ...
	 * @param param : 请求参数
	 */
	public static RespResult doPost(String url, Map<String, String> param) {
		RespResult result = null;
