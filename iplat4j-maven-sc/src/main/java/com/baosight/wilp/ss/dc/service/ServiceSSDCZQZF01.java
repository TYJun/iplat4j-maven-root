 ...
 * 
 * @Title: ServiceSSDCZQZF01.java
 * @ClassName: ServiceSSDCZQZF01
 * @Package：com.baosight.wilp.ss.dc.service
 * @author: liutao
 * @date: 2021年9月9日 下午3:40:00
 * @version: V1.0
 ...
 * <desc>    // 描述修改内容
 */
public class ServiceSSDCZQZF01 extends ServiceBase{
	...
	public EiInfo query(EiInfo inInfo) {
		EiInfo outInfo = super.query(inInfo, "SSDCZQZF01.query", new SSDCZQZF01());
		return outInfo;
	}
	 ...
	 * @return: EiInfo 
	 * @author: liutao
	 * @date: 2021年9月9日 下午3:42:59
	 */
	public EiInfo query2(EiInfo inInfo) {
		EiInfo outInfo = super.query(inInfo, "SSDCZQZF01.query2", new SSDCZQZF01(),false, null, EiConstant.queryBlock, "result2", "result2");
		return outInfo;
	}
