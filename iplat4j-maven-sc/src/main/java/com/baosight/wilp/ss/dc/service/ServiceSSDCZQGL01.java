 ...
 * 
 * @Title: ServiceSSDCZQGL01.java
 * @ClassName: ServiceSSDCZQGL01
 * @Package：com.baosight.wilp.ss.dc.service
 * @author: liutao
 * @date: 2021年9月9日 下午3:37:47
 * @version: V1.0
 ...
 * <desc>    // 描述修改内容
 */
public class ServiceSSDCZQGL01 extends ServiceBase{
	...
	public EiInfo query(EiInfo inInfo) {
		EiInfo outInfo = super.query(inInfo, "SSDCZQGL01.query", new SSDCZQGL01());
		return outInfo;
	}
	 ...
	 * @return: EiInfo 
	 * @author: liutao
	 * @date: 2021年9月9日 下午3:38:50
	 */
	public EiInfo query2(EiInfo inInfo) {
		EiInfo outInfo = super.query(inInfo, "SSDCZQGL01.query2", new SSDCZQGL01(),false, null, EiConstant.queryBlock, "result2", "result2");
		return outInfo;
	}
