...
<EF:EFPage title="编辑设备参数">
	<EF:EFRegion id="register" title="编辑" fitHeight="true">
		<div class="row">
			...
			<EF:EFInput ename="classifyName" cname="设备系统分类：" colWidth="6" type="hidden"/>
			<EF:EFInput ename="paramKey" cname="参数编码：" colWidth="6" type="hidden"/>
