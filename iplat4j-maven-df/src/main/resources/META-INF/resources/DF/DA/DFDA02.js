$(function() {
	...
	// 管理科室
	var reqDeptNum = __ei.managerDepartId;
	var reqDeptName = __ei.managerDepartName;
	IPLAT.EFPopupInput.value($("#reqDeptName"),reqDeptNum);
	IPLAT.EFPopupInput.text($("#reqDeptName"),reqDeptName);
	// 使用科室
...
//			},
	...
	$("#RESAVE").click(function(){
		...
		if (validator.validate()) {
			...
			eiInfo.set();
			EiCommunicator.send("DFDA02", "edit", eiInfo, {
