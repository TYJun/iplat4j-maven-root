...
<%--			<EF:EFInput ename="matName" cname="物资名称" colWidth="4" ratio="3:8" />--%>
	...
	<EF:EFRegion title="参数信息">
		<EF:EFGrid blockId="result" fitHeight="true" autoDraw="no" serviceName="DFFL10" queryMethod="queryParameter">
	...
	<EF:EFWindow id="fileChoose" url="" lazyload="true" refresh="true" width="40%" height="30%">
		<EF:EFRegion id="upload" title="文件上传">
			<EF:EFUpload ename="dfdaFiles" docTag="dfda_files" path="DA" showFileList="true"/>
		</EF:EFRegion>
	</EF:EFWindow>
	<%-- <EF:EFRegion title="文件上传">
		<EF:EFUpload ename="dfdaFiles" docTag="dfda_files" path="DA" showFileList="false"/>
	</EF:EFRegion> --%>
</EF:EFPage>