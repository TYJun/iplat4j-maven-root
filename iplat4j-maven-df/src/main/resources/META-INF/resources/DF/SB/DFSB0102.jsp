...
<%--	  </div>--%>
		<div title="设备零部件">
		   	<EF:EFGrid blockId="resultB" fitHeight="true" autoDraw="no" serviceName="DFSB0102" queryMethod="query">
				...
				<EF:EFColumn ename="nextCheckDate" cname="下次检验日期" editType="datetime" dateFormat="yyyy-MM-dd HH:mm:ss"
							 parseFormats="['yyyy-MM-dd HH:mm:ss']" readOnly="true"/>
		</EF:EFGrid>
		</div>
		<div title="文件列表">
			<EF:EFGrid blockId="resultC" fitHeight="true" autoDraw="no"  queryMethod="queryFile">
				<EF:EFColumn ename="id" cname="主键" hidden="true"/>
		...
		<div title="图片列表">
			<EF:EFGrid blockId="resultD" fitHeight="true" autoDraw="no"  queryMethod="queryFile">
				<EF:EFColumn ename="id" cname="主键" hidden="true"/>
	...
	<EF:EFWindow id="fileChoose" url="" lazyload="true" refresh="true" width="40%" height="30%">
		<EF:EFRegion id="uploadA" title="文件上传">
			<EF:EFUpload ename="projectm" docTag="sb_file" path="file" showFileList="true"/>
		</EF:EFRegion>
	</EF:EFWindow>
	<!-- 附件上传窗口 -->
	<EF:EFWindow id="picChoose" url="" lazyload="true" refresh="true" width="40%" height="30%">
		<EF:EFRegion id="uploadB" title="图片上传">
