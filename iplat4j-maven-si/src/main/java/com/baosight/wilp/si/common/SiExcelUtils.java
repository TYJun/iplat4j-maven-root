...
public class SiExcelUtils {
     ...
     * @throws
     **/
    public static List<String[]> parseExcel(InputStream inputStream, SiExcelImportService service) throws IOException, InvalidFormatException {
     ...
     * @throws
     */
    public static Workbook createWorkBook(List<SiExcelHeader> headList, List<String[]> dataList) {
        ...
        for (int i = 0; i < headList.size(); i++) {
            SiExcelHeader excelHeader = headList.get(i);
     ...
     * @throws
     **/
    private static void setDataValidation(Sheet sheet, List<SiExcelHeader> headList) {
        DataValidationHelper helper = sheet.getDataValidationHelper();
        //遍历
        for (int i = 0; i < headList.size(); i++) {
            SiExcelHeader header = headList.get(i);
            if(SiExcelHeader.TYPE_SELECT.equals(header.getHeaderType())) {
                //加载下拉列表内容
