...
* 
*/
public class SiOut extends DaoEPBase {
    ...
    private String costDeptNum = " ";		/* 成本科室*/
    private String costDeptName = " ";		/* 成本科室名称*/
    ...
    public void initMetaData() {
        ...
        eiColumn.setDescName("成本科室");
        eiMetadata.addMeta(eiColumn);

        eiColumn = new EiColumn("costDeptName");
        eiColumn.setDescName("成本科室名称");
        eiMetadata.addMeta(eiColumn);
        ...
        eiColumn.setDescName("打印标记(0=未打印,1=已打印)");
        eiMetadata.addMeta(eiColumn);
	...
	public void fromMap(Map map) {
        ...
        setCostDeptNum(StringUtils.defaultIfEmpty(StringUtils.toString(map.get("costDeptNum")), costDeptNum));
        setCostDeptName(StringUtils.defaultIfEmpty(StringUtils.toString(map.get("costDeptName")), costDeptName));
        ...
        setSignature(StringUtils.defaultIfEmpty(StringUtils.toString(map.get("signature")), signature));
    }
