 ...
 * @author fangjian
 */
public class SiConfig extends DaoEPBase {
    ...
    public void fromMap(Map map) {
        ...
        setConfigCode(SiUtils.isEmpty(map.get("configCode"), configCode));
        setConfigName(SiUtils.isEmpty(map.get("configName"), configName));
        setConfigValueRadio(SiUtils.isEmpty(map.get("configValueRadio"), configValueRadio));
        setConfigValueText(SiUtils.isEmpty(map.get("configValueText"), configValueText));
