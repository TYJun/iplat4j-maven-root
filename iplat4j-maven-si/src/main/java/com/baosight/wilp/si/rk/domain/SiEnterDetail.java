...
/**
* SiEnterDetail ： 入库明细表实体
* 
*/
public class SiEnterDetail extends DaoEPBase {
    ...
    /**入库明细单号*/
    private String enterBillDetailNo = " ";
    ...
    /**最低库存量*/
    private Double minNum = new Double(0);
    ...
    /**入库总价*/
    private Double enterAmount = new Double(0);
    ...
    /**红冲数量*/
    private Double redRushNum = new Double(0);
