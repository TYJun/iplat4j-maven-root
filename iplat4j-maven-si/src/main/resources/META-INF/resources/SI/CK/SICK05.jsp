...
<EF:EFPage>
	...
	<EF:EFRegion id="result" title="出库单信息">
		...
		<EF:EFRegion id="detail" title="物资信息">
			...
			sort="single">
				...
				<EF:EFColumn ename="matName" cname="物资名称" width="100" enable="false" align="center" sort="true"/>
				...
				<EF:EFColumn ename="outNum" cname="送货数量" width="100" align="center" sort="true"/>
