...
<EF:EFPage>
	...
	<EF:EFRegion id="result" title="仓库预警生成">
		<EF:EFGrid blockId="result" autoDraw="no" height="400" checkMode="row">
			...
			<EF:EFColumn ename="totalNum" cname="库存量" width="100" enable="false" align="center"/>
			<EF:EFColumn ename="minNum" cname="库存下限" width="100" align="center"/>
			<EF:EFColumn ename="maxNum" cname="库存上限" width="100" align="center"/>
		</EF:EFGrid>
	</EF:EFRegion>
</EF:EFPage>
