...
<EF:EFPage>
	...
	<EF:EFRegion id="result" title="盘库明细信息">
		<EF:EFGrid blockId="result" autoDraw="no" checkMode="row">
			...
			<EF:EFColumn ename="price" cname="盘点单价(元)" width="100" align="center"/>
		</EF:EFGrid>
	</EF:EFRegion>
	<!-- 新增盘点物资弹窗 -->
	<EF:EFWindow id="popDataAddMat" title="新增盘点物资" url=" " lazyload="true" width="100%" height="100%"></EF:EFWindow>
</EF:EFPage>
...
$(function() {
	...
	if (op == "see") {
		...
		$("#ADDINVENMAT").css("visibility", "hidden");
	}else if (op == "pdxxxwh") {
		$("#PASS").css("display", "none");
	}else{
		$("#COMFIRM").css("display", "none");
