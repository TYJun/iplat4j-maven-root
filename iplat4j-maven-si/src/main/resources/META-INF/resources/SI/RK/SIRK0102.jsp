...
<title>手工入库</title>
<EF:EFPage>
	<EF:EFRegion id="inqu" title="手工入库信息">
		<div class="row">
			...
			<EF:EFPopupInput ename="inqu_status-0-deptNum" cname="领用科室" popupTitle="科室选择" readOnly="true"
	...
	<EF:EFRegion id="result" title="手工入库信息">
		<EF:EFGrid blockId="result" autoDraw="no"  height="400" checkMode="multiple,row" serviceName="TSFW01" queryMethod="loadTempData">
