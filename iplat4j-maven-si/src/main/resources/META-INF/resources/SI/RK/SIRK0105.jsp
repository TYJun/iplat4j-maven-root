...
<%
	...
	try {
		...
		Resource[] resources = resolver.getResources("jasperReport/enterBill.jrxml");
		...
		String[] enterBillNos = request.getParameter("enterBillNos").split(",");
		...
		//将打印标记改为已打印
		SiUtils.invoke(null, "SIRK01", "updatePrintFlag", new String[]{"enterBillNos"}, request.getParameter("enterBillNos") );
	} catch (Exception e) {
		e.printStackTrace();
	} finally {
		if (conn != null){
