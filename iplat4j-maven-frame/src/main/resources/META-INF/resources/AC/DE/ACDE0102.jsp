...
<EF:EFPage >
    <EF:EFRegion id="result" title="修改科室" fitHeight="true" >

		<div class="row">

			<EF:EFInput ename="id" cname="科室ID" colWidth="5" readonly="true" type="hidden" />
...
<script type="text/javascript">
	...
	$(function() {
		...
		$("#parentDeptName_textField").val(__ei.parentDeptName);
		...
		$("#SUBMIT").on("click", function (e) {
			...
			EiCommunicator.send("ACDE0102", "update", eiInfo, {
