...
<%--		  		</EF:EFSelect>--%>
				...
				<EF:EFInput ename="receiver" cname="接收人工号" />
		...
		<EF:EFRegion id="result" title="消息列表">
			<EF:EFGrid blockId="result" autoDraw="no"  readonly="true">
				<EF:EFColumn ename="isSuccess" cname="状态"  width="80" align="center" />
				<EF:EFColumn ename="id" cname="主键" width="100" hidden="true" />
				<EF:EFColumn ename="templateCode" cname="模板编码" width="80" />
				<EF:EFColumn ename="templateId" cname="模板ID" width="80"  hidden="true"/>
				...
				<EF:EFColumn ename="receiver" cname="接受人工号"  width="80" />
				<EF:EFColumn ename="receiverText" cname="接受人姓名"  width="80" />
