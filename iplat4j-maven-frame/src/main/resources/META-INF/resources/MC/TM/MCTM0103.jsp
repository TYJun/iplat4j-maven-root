...
<EF:EFPage >
	 <EF:EFRegion id="result" title="试发短信" fitHeight="true" >
		
		<div class="row">
			<EF:EFInput ename="phone" cname="手机号" colWidth="5" />
...
$(function() {
	...
	$("#SEND").on("click", function (e) {
		...
		EiCommunicator.send("MCTM0103", "send", info, {
		onSuccess : function(ei) {
			NotificationUtil(ei.getMsg(), "success");
			window.parent['sendTextPopDataWindow'].close();
			}
		});  
