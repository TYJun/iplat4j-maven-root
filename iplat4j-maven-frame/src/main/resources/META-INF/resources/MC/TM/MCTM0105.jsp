...
<EF:EFPage >
	 <EF:EFRegion id="result" title="试推钉钉" fitHeight="true" >
		
		<div class="row">
			<EF:EFInput ename="phone" cname="电话" colWidth="5" />
...
$(function() {
	...
	$("#SEND").on("click", function (e) {
		...
		EiCommunicator.send("MCTM0105", "sendDing", info, {
		onSuccess : function(ei) {
			NotificationUtil(ei.getMsg(), "success");
			window.parent['pushDingPopDataWindow'].close();
			}
		});  
