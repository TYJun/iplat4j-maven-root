		...
		<EF:EFRegion id="result" title="资源列表">
			<EF:EFGrid blockId="result" autoDraw="no"  readonly="true">
				...
				<EF:EFComboColumn ename="type" cname="类型">
					<EF:EFCodeOption codeName="wilp.au.ar.type" valueField="value" textField="label"/>
				</EF:EFComboColumn>
			</EF:EFGrid>
		</EF:EFRegion>
	</div>
...
<script type="text/javascript">
	...
	$(function() {
		...
		$("#ADD").on("click", function (e) {
    		var url = IPLATUI.CONTEXT_PATH + "/web/AUAR0101";
		...
		$("#EDIT").on("click", function(e) {
			if (datagrid == null) {
				...
				var url = IPLATUI.CONTEXT_PATH + "/web/AUAR0102?"+"id=" + datagrid.id+
		...
		$("#DELETE").on("click", function(e) {
			...
			IPLAT.confirm({
				message:"确定删除选中行?",
				okFn:function(e){
					EiCommunicator.send("AUAR01", "delete", info, {
