 ...
 *
 */
public class ServiceMCTM0106 extends ServiceBase {
	...
	@SuppressWarnings("unchecked")
	public EiInfo sendWX(EiInfo inInfo) {

		// 1.获取token值
		inInfo.set(EiConstant.serviceName, "MCFW01");
		inInfo.set(EiConstant.methodName, "getWXToken");
		...
		// 5.推送消息
		String code = SendingWXMsgUtil.sendMsg(appId, token, "text", workNo, message);
