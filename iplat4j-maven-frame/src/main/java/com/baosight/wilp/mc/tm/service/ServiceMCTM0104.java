 ...
 *
 */
public class ServiceMCTM0104 extends ServiceBase {
	...
	@SuppressWarnings("unchecked")
	public EiInfo push(EiInfo inInfo) {

		// 1.获取token值
		inInfo.set(EiConstant.serviceName, "MCFW01");
		inInfo.set(EiConstant.methodName, "obtainToken");
		...
		// 5.推送消息
		String code = PushMsgUtil.pushMsg(message, cid, appId, token, null);
		
		inInfo.set("isSuccess", code);
