	...
	IPLATUI.EFTree = {
		"menu": {
			...
			select: function(e) {
			    ...
			    $("#classifyNameSS").val(_data[NODE.nodeTextField]);
			    if($("#classifyNameSS").val()=="分类信息"){
			    	$("#classifyNameSS").val("");
			    }
			    resultGrid.dataSource.page(1);
			},
	            	...
	            	$("#REGISTER").on("click", function (e) {
						...
						$("#addNode").unbind('click').click(function () {
							...
							if (validator.validate()) {
								...
								eiInfo.set("parentId", parentId);
								eiInfo.set("memo", $("#memo").val());
								EiCommunicator.send("DKFL01", "insert", eiInfo, {
									onSuccess: function () {
										addWndWindow.close();
	            	...
	            	$("#REEDIT").on("click", function (e) {
						...
						$("#editNode").unbind('click').click(function () {
							...
							if (validator.validate()) {
								...
								EiCommunicator.send("DKFL01", "update", eiInfo, {
									onSuccess: function () {
										// 重新加载父结点信息
	            		...
	            		var deleteHTML = kendo.template($("#del-template").html())(
							...
							WindowUtil({
								...
								ok: function () {
									...
									var eiInfo = new EiInfo();
									eiInfo.set("id", id);
									EiCommunicator.send("DKFL01", "deleteBatch", eiInfo, {
										onSuccess: function (eiInfo) {
