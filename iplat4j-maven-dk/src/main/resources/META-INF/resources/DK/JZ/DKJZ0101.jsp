...
<EF:EFPage title="基准新增">
	<EF:EFRegion id="ADD">
		<div class="row">
			...
			<%-- <EF:EFPopupInput ename="schemeDept" cname="巡检单位"  colWidth="4"
			    popupTitle="巡检单位选择" required="true" 
			    popupType="ServiceGrid" serviceName="DIJZ0101" methodName="queryDept" resultId="dept"
			    valueField="id" textField="deptName"
			    columnEnames="id,deptNum,deptName" columnCnames="id,科室编码,科室名称" /> --%>
			...
			<EF:EFPopupInput ename="schemeDept" cname="保养单位"  colWidth="4" ratio="4:8"
				popupTitle="科室选择" required="true" readonly="true"
				popupType="ServiceGrid" serviceName="DKJZ0101" methodName="queryDept" resultId="dept"
				valueField="deptNum" textField="deptName"
				columnEnames="deptNum,deptName" columnCnames="科室编码,科室名称" />
			
			<%-- <EF:EFPopupInput ename="schemeMan" cname="负责人"  colWidth="4"
			    popupTitle="负责人选择" required="true" 
			    popupType="ServiceGrid" serviceName="DIJZ0101" methodName="queryMan" resultId="man"
			    valueField="id" textField="name"
			    columnEnames="id,workNo,name,deptName" columnCnames="id,工号,姓名,科室" /> --%>
			    
			<%-- <EF:EFSelect ename="schemeMan" cname="负责人:" colWidth="4"
				resultId="man" textField="name" valueField="id"
				filter="contains" serviceName="DKJZ0101"
				methodName="queryMan" required="true">
			</EF:EFSelect> --%>
			
			<EF:EFPopupInput ename="schemeMan" cname="保养管理员：" colWidth="4" ratio="4:8"
				popupTitle="管理员选择" required="true" readonly="true"
				popupType="ServiceGrid" serviceName="DKJZ0101" methodName="queryMan" resultId="person"
	...
	<EF:EFRegion title="设备信息">
		<EF:EFGrid blockId="device" autoDraw="no" serviceName="DKJZ0101"
			showCount="false">
	...
	<EF:EFWindow id="popDataDevice" url="" lazyload="true" width="50%" height="80%" title="添加设备" modal="true" />		
		
	<EF:EFRegion title="周期">
		<EF:EFGrid blockId="cycle" autoDraw="no" serviceName="DKJZ0101">
	...
	<EF:EFRegion title="项目信息">
		<EF:EFGrid blockId="item" autoDraw="no" serviceName="DKJZ0101">
			...
			<EF:EFColumn ename="content" align="center" cname="保养作业项目名称" enable="false" />
			<EF:EFColumn ename="referenceValue" align="center" cname="保养项目参考值" enable="false" />
			<EF:EFColumn ename="projectDesc" align="center" cname="保养作业说明" enable="false" />
