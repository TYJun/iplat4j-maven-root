			...
			"device": {
				loadComplete: function (grid) {
					...
					$("#ADDDEVICE").on("click", function (e) {
						var url = IPLATUI.CONTEXT_PATH + "/web/DKJZ010101";
					...
					$("#ADDPACDEVICE").on("click", function (e) {
						if(operType=="update"){
							...
							var url = IPLATUI.CONTEXT_PATH + "/web/DKJZ010105";
			...
			"cycle": {
				loadComplete: function (grid) {
					$("#ADDCYCLE").on("click", function (e) {
						var url = IPLATUI.CONTEXT_PATH + "/web/DKJZ010102";
...
//						var cycle = checkRows[0].id;
			...
			"item": {
				loadComplete: function (grid) {
					$("#ADDITEM").on("click", function (e) {
						...
						var url = IPLATUI.CONTEXT_PATH + "/web/DKJZ010103?schemeID="+schemeID;
					...
					$("#ADDPACITEM").on("click", function (e) {
						var url = IPLATUI.CONTEXT_PATH + "/web/DKJZ010106";
			...
			"exman": {
				loadComplete: function (grid) {
					$("#ADDEXMAN").on("click", function (e) {
						var url = IPLATUI.CONTEXT_PATH + "/web/DKJZ010104";
	...
	$("#SUBMIT").click(function() {
		...
		EiCommunicator.send("DKJZ0101", "insertScheme", info, {
	...
	function validate(schemeName,departID,managerID,activeTime,timeoutReminderTime) {
		...
		if(isEmpty(departID) || departID=="--请选择--"){
			NotificationUtil("保养单位不能为空", "error");
			return false;
		} 
		if(isEmpty(managerID) || managerID=="--请选择--"){
			NotificationUtil("保养管理员不能为空", "error");
			return false;
		} 
